...
@dataclass(frozen=False)
class account_group_assignment_full_dtos(base_dtos):
    dtos: list[account_group_assignment_full_dto]
    def __init__(self, dtos: list[account_group_assignment_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[account_group_assignment_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: account_group_assignment_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[account_group_assignment_full_dto], dtos2: list[account_group_assignment_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> account_group_assignment_full_dto | None:
        found_dtos = list(filter(lambda x: x.account_group_assignment_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, account_group_assignment_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class account_group_role_full_dtos(base_dtos):
    dtos: list[account_group_role_full_dto]
    def __init__(self, dtos: list[account_group_role_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[account_group_role_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: account_group_role_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[account_group_role_full_dto], dtos2: list[account_group_role_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> account_group_role_full_dto | None:
        found_dtos = list(filter(lambda x: x.account_group_role_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, account_group_role_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class account_title_assignment_full_dtos(base_dtos):
    dtos: list[account_title_assignment_full_dto]
    def __init__(self, dtos: list[account_title_assignment_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[account_title_assignment_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: account_title_assignment_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[account_title_assignment_full_dto], dtos2: list[account_title_assignment_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> account_title_assignment_full_dto | None:
        found_dtos = list(filter(lambda x: x.account_title_assignment_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, account_title_assignment_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class connection_tenant_full_dtos(base_dtos):
    dtos: list[connection_tenant_full_dto]
    def __init__(self, dtos: list[connection_tenant_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[connection_tenant_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: connection_tenant_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[connection_tenant_full_dto], dtos2: list[connection_tenant_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> connection_tenant_full_dto | None:
        found_dtos = list(filter(lambda x: x.connection_tenant_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, connection_tenant_full_dto]:
        res = {}
        for dto in self.dtos:
...
class location_postal_code_full_dtos(base_dtos):
    ...
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[location_postal_code_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: location_postal_code_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[location_postal_code_full_dto], dtos2: list[location_postal_code_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> location_postal_code_full_dto | None:
        found_dtos = list(filter(lambda x: x.location_postal_code_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, location_postal_code_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class location_territory_full_dtos(base_dtos):
    dtos: list[location_territory_full_dto]
    def __init__(self, dtos: list[location_territory_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[location_territory_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: location_territory_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[location_territory_full_dto], dtos2: list[location_territory_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> location_territory_full_dto | None:
        found_dtos = list(filter(lambda x: x.location_territory_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, location_territory_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class storage_category_full_dtos(base_dtos):
    dtos: list[storage_category_full_dto]
    def __init__(self, dtos: list[storage_category_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[storage_category_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: storage_category_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[storage_category_full_dto], dtos2: list[storage_category_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> storage_category_full_dto | None:
        found_dtos = list(filter(lambda x: x.storage_category_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, storage_category_full_dto]:
        res = {}
        for dto in self.dtos:
...
@dataclass(frozen=False)
class system_constraint_full_dtos(base_dtos):
    dtos: list[system_constraint_full_dto]
    def __init__(self, dtos: list[system_constraint_full_dto]):
        super().__init__(dtos)
        self.dtos = dtos
    @classmethod
    def empty_list(cls):
        return cls(list())
    @classmethod
    def from_list(cls, dtos: list[system_constraint_full_dto]):
        return cls(dtos)
    @classmethod
    def from_object(cls, dto: system_constraint_full_dto):
        return cls([dto])
    @classmethod
    def from_lists(cls, dtos1: list[system_constraint_full_dto], dtos2: list[system_constraint_full_dto]):
        return cls(dtos1 + dtos2)
    def find_by_uid(self, uid: str) -> system_constraint_full_dto | None:
        found_dtos = list(filter(lambda x: x.system_constraint_uid == uid, self.dtos))
        if (len(found_dtos)>0):
            return found_dtos[0]
        else:
            return None
    def map_by_uid(self) -> dict[str, system_constraint_full_dto]:
        res = {}
        for dto in self.dtos:
