...
from dto.dtos_models import account_division_model
...
def test_model_sqls():
    ...
    print(account_division_model.get_select_all_limit_sql())
    print(account_division_model.get_key_column_name())
    print(account_division_model.get_select_all_latest_sql())
    print(account_division_model.get_select_all_keys())
    print(account_division_model.get_select_all_keys(500))
    print(account_division_model.get_select_count_all_sql())
    print(account_division_model.get_select_count_active_sql())
...
def test_model():
    print(account_division_model.table_name)
    print(account_division_model.key_column_name)
    print(account_division_model.all_columns)
    print("attr_columns")
    print(account_division_model.attr_columns)
    print("all_columns_list")
    print(account_division_model.all_columns_list)
    print("attr_columns_list")
    print(account_division_model.attr_columns_list)
    print("attr_no_uid_columns")
    print(account_division_model.attr_no_uid_columns)
    print("attr_no_uid_columns_list")
    print(account_division_model.attr_no_uid_columns_list)
    print("all_question_marks")
    print(account_division_model.all_question_marks)
    print("attr_question_marks")
    print(account_division_model.attr_question_marks)
    print("insert_attrs_sql")
    print(account_division_model.insert_attrs_sql)
    print("update_attrs_sql")
    print(account_division_model.update_attrs_sql)
    print("upsert_columns")
    print(account_division_model.upsert_columns)
    print("upsert_columns_exclude_list")
    print(account_division_model.upsert_columns_exclude_list)
    print("upsert_attrs_sql")
    print(account_division_model.upsert_attrs_sql)


if __name__ == '__main__':
    test_customdao_insert()
