...
class DaosList(base_object):
    ...
    account_group_assignment_dao_instance = account_group_assignment_full_dao()
    account_group_role_dao_instance = account_group_role_full_dao()
    ...
    storage_category_dao_instance = storage_category_full_dao()
    ...
    system_constraint_dao_instance = system_constraint_full_dao()
    ...
    def register_all_standard_daos(self):
        ...
        self.all_daos["account_group_assignment_dao"] = self.account_group_assignment_dao_instance
        self.all_daos["account_group_role_dao"] = self.account_group_role_dao_instance
        ...
        self.all_daos["storage_category_dao"] = self.storage_category_dao_instance
        ...
        self.all_daos["system_constraint_dao"] = self.system_constraint_dao_instance
