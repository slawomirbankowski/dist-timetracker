# auto-generated - v_definition_dtos_write - START
import datetime
...
class account_write_dto(base_write_dto):
    ...
    display_name: str
    is_system: int
    def __init__(self, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0)
    @classmethod
    def new_write(cls, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int):
        return cls(account_uid, account_name, tenant_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, display_name, is_system)
    @classmethod
    def new_write_with_defaults(cls, account_uid: str = "", account_name: str = "", tenant_uid: str = "", account_type_uid: str = "", account_title_uid: str = "", account_division_uid: str = "", account_group_uid: str = "", auth_identity_uid: str = "", account_email: str = "", display_name: str = "", is_system: int = 0):
        return cls(account_uid, account_name, tenant_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, display_name, is_system)
    @classmethod
    def new_write_random_uid(cls, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int):
        return cls(base_dto.get_random_uid(), account_name, tenant_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, display_name, is_system)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.account_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["account_uid"], d["account_name"], d["tenant_uid"], d["account_type_uid"], d["account_title_uid"], d["account_division_uid"], d["account_group_uid"], d["auth_identity_uid"], d["account_email"], d["display_name"], d["is_system"])
    ...
    def clone_write_new_uid(self):
        return account_write_dto(base_dto.get_random_uid(), self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return account_write_dto(uid, self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.custom_attributes)
    ...
    def get_list_values(self) -> list[any]:
        return [self.account_uid, self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.account_uid, self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.custom_attributes, updated_by, self.account_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.account_uid, self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.custom_attributes]
    ...
    def update_uid_attributes(self, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int):
        self.account_uid = account_uid
        self.account_name = account_name
        self.tenant_uid = tenant_uid
        self.account_type_uid = account_type_uid
        ...
        self.display_name = display_name
        self.is_system = is_system
    def update_attributes(self, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int):
        self.account_name = account_name
        self.tenant_uid = tenant_uid
        self.account_type_uid = account_type_uid
        self.account_title_uid = account_title_uid
...
class account_title_responsibility_write_dto(base_write_dto):
    ...
    def __init__(self, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int, custom_attributes: str = "{}"):
    ...
    @classmethod
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0)
    @classmethod
    def new_write(cls, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int):
        return cls(account_title_responsibility_uid, account_title_responsibility_name, tenant_uid, account_title_uid, responsibility_description, responsibility_priority)
    @classmethod
    def new_write_with_defaults(cls, account_title_responsibility_uid: str = "", account_title_responsibility_name: str = "", tenant_uid: str = "", account_title_uid: str = "", responsibility_description: str = "", responsibility_priority: int = 0):
        return cls(account_title_responsibility_uid, account_title_responsibility_name, tenant_uid, account_title_uid, responsibility_description, responsibility_priority)
    @classmethod
    def new_write_random_uid(cls, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int):
        return cls(base_dto.get_random_uid(), account_title_responsibility_name, tenant_uid, account_title_uid, responsibility_description, responsibility_priority)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.account_title_responsibility_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["account_title_responsibility_uid"], d["account_title_responsibility_name"], d["tenant_uid"], d["account_title_uid"], d["responsibility_description"], d["responsibility_priority"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return account_title_responsibility_write_dto(base_dto.get_random_uid(), self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return account_title_responsibility_write_dto(uid, self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.account_title_responsibility_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.account_title_responsibility_uid, self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.account_title_responsibility_uid, self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, self.custom_attributes, updated_by, self.account_title_responsibility_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.account_title_responsibility_uid, self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.account_title_responsibility_name, self.tenant_uid, self.account_title_uid, self.responsibility_description, self.responsibility_priority, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int):
        self.account_title_responsibility_uid = account_title_responsibility_uid
        self.account_title_responsibility_name = account_title_responsibility_name
        self.tenant_uid = tenant_uid
        self.account_title_uid = account_title_uid
        self.responsibility_description = responsibility_description
        self.responsibility_priority = responsibility_priority
    def update_attributes(self, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int):
        self.account_title_responsibility_name = account_title_responsibility_name
        self.tenant_uid = tenant_uid
        self.account_title_uid = account_title_uid
        self.responsibility_description = responsibility_description
...
class account_type_write_dto(base_write_dto):
    ...
    def __init__(self, account_type_uid: str, account_type_name: str, account_type_description: str, custom_attributes: str = "{}"):
        self.account_type_uid = account_type_uid
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, account_type_uid: str, account_type_name: str, account_type_description: str):
        return cls(account_type_uid, account_type_name, account_type_description)
    @classmethod
    def new_write_with_defaults(cls, account_type_uid: str = "", account_type_name: str = "", account_type_description: str = ""):
        return cls(account_type_uid, account_type_name, account_type_description)
    @classmethod
    def new_write_random_uid(cls, account_type_name: str, account_type_description: str):
        return cls(base_dto.get_random_uid(), account_type_name, account_type_description)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.account_type_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["account_type_uid"], d["account_type_name"], d["account_type_description"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return account_type_write_dto(base_dto.get_random_uid(), self.account_type_name, self.account_type_description, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return account_type_write_dto(uid, self.account_type_name, self.account_type_description, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.account_type_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.account_type_uid, self.account_type_name, self.account_type_description, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.account_type_uid, self.account_type_name, self.account_type_description]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.account_type_name, self.account_type_description, self.custom_attributes, updated_by, self.account_type_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.account_type_uid, self.account_type_name, self.account_type_description, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.account_type_name, self.account_type_description]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.account_type_name, self.account_type_description, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, account_type_uid: str, account_type_name: str, account_type_description: str):
        self.account_type_uid = account_type_uid
        self.account_type_name = account_type_name
        self.account_type_description = account_type_description
    def update_attributes(self, account_type_name: str, account_type_description: str):
        self.account_type_name = account_type_name
        self.account_type_description = account_type_description
...
class audit_change_write_dto(base_write_dto):
    ...
    change_type: str
    change_json: str
    def __init__(self, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str):
        return cls(system_change_uid, system_change_name, account_uid, audit_type_uid, change_type, change_json)
    @classmethod
    def new_write_with_defaults(cls, system_change_uid: str = "", system_change_name: str = "", account_uid: str = "", audit_type_uid: str = "", change_type: str = "", change_json: str = ""):
        return cls(system_change_uid, system_change_name, account_uid, audit_type_uid, change_type, change_json)
    @classmethod
    def new_write_random_uid(cls, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str):
        return cls(base_dto.get_random_uid(), system_change_uid, system_change_name, account_uid, audit_type_uid, change_type, change_json)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.audit_change_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_change_uid"], d["system_change_name"], d["account_uid"], d["audit_type_uid"], d["change_type"], d["change_json"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return audit_change_write_dto(base_dto.get_random_uid(), self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return audit_change_write_dto(uid, self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.audit_change_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.custom_attributes, updated_by, self.audit_change_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.audit_change_uid, self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.custom_attributes]
    ...
    def update_uid_attributes(self, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str):
        self.system_change_uid = system_change_uid
        self.system_change_name = system_change_name
        self.account_uid = account_uid
        self.audit_type_uid = audit_type_uid
        self.change_type = change_type
        self.change_json = change_json
    def update_attributes(self, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str):
        self.system_change_uid = system_change_uid
        self.system_change_name = system_change_name
        self.account_uid = account_uid
        self.audit_type_uid = audit_type_uid
...
class auth_session_write_dto(base_write_dto):
    ...
    browser_name: str
    browser_: str
    def __init__(self, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str):
        return cls(auth_session_uid, auth_session_name, tenant_uid, account_uid, session_token, browser_name, browser_)
    @classmethod
    def new_write_with_defaults(cls, auth_session_uid: str = "", auth_session_name: str = "", tenant_uid: str | None = "", account_uid: str | None = "", session_token: str = "", browser_name: str = "", browser_: str = ""):
        return cls(auth_session_uid, auth_session_name, tenant_uid, account_uid, session_token, browser_name, browser_)
    @classmethod
    def new_write_random_uid(cls, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str):
        return cls(base_dto.get_random_uid(), auth_session_name, tenant_uid, account_uid, session_token, browser_name, browser_)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.auth_session_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["auth_session_uid"], d["auth_session_name"], d["tenant_uid"], d["account_uid"], d["session_token"], d["browser_name"], d["browser_"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return auth_session_write_dto(base_dto.get_random_uid(), self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return auth_session_write_dto(uid, self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.auth_session_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.auth_session_uid, self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.auth_session_uid, self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.custom_attributes, updated_by, self.auth_session_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.auth_session_uid, self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str):
        self.auth_session_uid = auth_session_uid
        self.auth_session_name = auth_session_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        ...
        self.browser_name = browser_name
        self.browser_ = browser_
    def update_attributes(self, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str):
        self.auth_session_name = auth_session_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        self.session_token = session_token
...
class client_account_write_dto(base_write_dto):
    ...
    account_uid: str
    client_role_uid: str
    def __init__(self, client_account_uid: str, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, client_account_uid: str, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str):
        return cls(client_account_uid, client_account_name, tenant_uid, client_uid, account_uid, client_role_uid)
    @classmethod
    def new_write_with_defaults(cls, client_account_uid: str = "", client_account_name: str = "", tenant_uid: str = "", client_uid: str = "", account_uid: str = "", client_role_uid: str = ""):
        return cls(client_account_uid, client_account_name, tenant_uid, client_uid, account_uid, client_role_uid)
    @classmethod
    def new_write_random_uid(cls, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str):
        return cls(base_dto.get_random_uid(), client_account_name, tenant_uid, client_uid, account_uid, client_role_uid)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.client_account_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["client_account_uid"], d["client_account_name"], d["tenant_uid"], d["client_uid"], d["account_uid"], d["client_role_uid"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return client_account_write_dto(base_dto.get_random_uid(), self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return client_account_write_dto(uid, self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.client_account_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.client_account_uid, self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.client_account_uid, self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, self.custom_attributes, updated_by, self.client_account_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.client_account_uid, self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.client_account_name, self.tenant_uid, self.client_uid, self.account_uid, self.client_role_uid, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, client_account_uid: str, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str):
        self.client_account_uid = client_account_uid
        self.client_account_name = client_account_name
        self.tenant_uid = tenant_uid
        self.client_uid = client_uid
        self.account_uid = account_uid
        self.client_role_uid = client_role_uid
    def update_attributes(self, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str):
        self.client_account_name = client_account_name
        self.tenant_uid = tenant_uid
        self.client_uid = client_uid
        self.account_uid = account_uid
...
class client_country_write_dto(base_write_dto):
    ...
    client_uid: str
    country_uid: str
    def __init__(self, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str):
        return cls(client_country_uid, client_country_name, tenant_uid, client_uid, country_uid)
    @classmethod
    def new_write_with_defaults(cls, client_country_uid: str = "", client_country_name: str = "", tenant_uid: str = "", client_uid: str = "", country_uid: str = ""):
        return cls(client_country_uid, client_country_name, tenant_uid, client_uid, country_uid)
    @classmethod
    def new_write_random_uid(cls, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str):
        return cls(base_dto.get_random_uid(), client_country_name, tenant_uid, client_uid, country_uid)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.client_country_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["client_country_uid"], d["client_country_name"], d["tenant_uid"], d["client_uid"], d["country_uid"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return client_country_write_dto(base_dto.get_random_uid(), self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return client_country_write_dto(uid, self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.client_country_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.client_country_uid, self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.client_country_uid, self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.custom_attributes, updated_by, self.client_country_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.client_country_uid, self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str):
        self.client_country_uid = client_country_uid
        self.client_country_name = client_country_name
        self.tenant_uid = tenant_uid
        self.client_uid = client_uid
        self.country_uid = country_uid
    def update_attributes(self, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str):
        self.client_country_name = client_country_name
        self.tenant_uid = tenant_uid
        self.client_uid = client_uid
        self.country_uid = country_uid
...
class currency_write_dto(base_write_dto):
    ...
    @classmethod
    def new_write_with_defaults(cls, currency_uid: str = "", currency_name: str = "", is_focused: int = 0):
        return cls(currency_uid, currency_name, is_focused)
    @classmethod
...
class event_instance_write_dto(base_write_dto):
    ...
    published_count: int
    def __init__(self, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int, custom_attributes: str = "{}"):
    ...
    @classmethod
    def new_write(cls, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int):
        return cls(event_instance_uid, event_instance_name, client_uid, event_type, event_object, event_method, event_parameters, event_signature, event_date, published_count)
    @classmethod
    def new_write_with_defaults(cls, event_instance_uid: str = "", event_instance_name: str = "", client_uid: str = "", event_type: str = "", event_object: str = "", event_method: str = "", event_parameters: str = "", event_signature: str = "", event_date: datetime.datetime = datetime.datetime.now(), published_count: int = 0):
        return cls(event_instance_uid, event_instance_name, client_uid, event_type, event_object, event_method, event_parameters, event_signature, event_date, published_count)
    @classmethod
    def new_write_random_uid(cls, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int):
        return cls(base_dto.get_random_uid(), event_instance_name, client_uid, event_type, event_object, event_method, event_parameters, event_signature, event_date, published_count)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.event_instance_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["event_instance_uid"], d["event_instance_name"], d["client_uid"], d["event_type"], d["event_object"], d["event_method"], d["event_parameters"], d["event_signature"], d["event_date"], d["published_count"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return event_instance_write_dto(base_dto.get_random_uid(), self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return event_instance_write_dto(uid, self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.event_instance_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.event_instance_uid, self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.event_instance_uid, self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.custom_attributes, updated_by, self.event_instance_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.event_instance_uid, self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int):
        self.event_instance_uid = event_instance_uid
        self.event_instance_name = event_instance_name
        self.client_uid = client_uid
        self.event_type = event_type
        ...
        self.event_date = event_date
        self.published_count = published_count
    def update_attributes(self, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int):
        self.event_instance_name = event_instance_name
        self.client_uid = client_uid
        self.event_type = event_type
        self.event_object = event_object
...
class event_observer_write_dto(base_write_dto):
    ...
    def __init__(self, event_observer_uid: str, event_observer_name: str, event_observer_definition: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, event_observer_uid: str, event_observer_name: str, event_observer_definition: str):
        return cls(event_observer_uid, event_observer_name, event_observer_definition)
    @classmethod
    def new_write_with_defaults(cls, event_observer_uid: str = "", event_observer_name: str = "", event_observer_definition: str = ""):
        return cls(event_observer_uid, event_observer_name, event_observer_definition)
    @classmethod
    def new_write_random_uid(cls, event_observer_name: str, event_observer_definition: str):
        return cls(base_dto.get_random_uid(), event_observer_name, event_observer_definition)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.event_observer_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["event_observer_uid"], d["event_observer_name"], d["event_observer_definition"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return event_observer_write_dto(base_dto.get_random_uid(), self.event_observer_name, self.event_observer_definition, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return event_observer_write_dto(uid, self.event_observer_name, self.event_observer_definition, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.event_observer_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.event_observer_uid, self.event_observer_name, self.event_observer_definition, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.event_observer_uid, self.event_observer_name, self.event_observer_definition]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.event_observer_name, self.event_observer_definition, self.custom_attributes, updated_by, self.event_observer_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.event_observer_uid, self.event_observer_name, self.event_observer_definition, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.event_observer_name, self.event_observer_definition]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.event_observer_name, self.event_observer_definition, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, event_observer_uid: str, event_observer_name: str, event_observer_definition: str):
        self.event_observer_uid = event_observer_uid
        self.event_observer_name = event_observer_name
        self.event_observer_definition = event_observer_definition
    def update_attributes(self, event_observer_name: str, event_observer_definition: str):
        self.event_observer_name = event_observer_name
        self.event_observer_definition = event_observer_definition
...
class invoice_flow_write_dto(base_write_dto):
    ...
    def __init__(self, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str):
        return cls(invoice_flow_uid, invoice_flow_name, flow_description, flow_definition_json)
    @classmethod
    def new_write_with_defaults(cls, invoice_flow_uid: str = "", invoice_flow_name: str = "", flow_description: str = "", flow_definition_json: str = ""):
        return cls(invoice_flow_uid, invoice_flow_name, flow_description, flow_definition_json)
    @classmethod
    def new_write_random_uid(cls, invoice_flow_name: str, flow_description: str, flow_definition_json: str):
        return cls(base_dto.get_random_uid(), invoice_flow_name, flow_description, flow_definition_json)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.invoice_flow_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["invoice_flow_uid"], d["invoice_flow_name"], d["flow_description"], d["flow_definition_json"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return invoice_flow_write_dto(base_dto.get_random_uid(), self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return invoice_flow_write_dto(uid, self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.invoice_flow_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.invoice_flow_uid, self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.invoice_flow_uid, self.invoice_flow_name, self.flow_description, self.flow_definition_json]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.custom_attributes, updated_by, self.invoice_flow_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.invoice_flow_uid, self.invoice_flow_name, self.flow_description, self.flow_definition_json, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.invoice_flow_name, self.flow_description, self.flow_definition_json]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str):
        self.invoice_flow_uid = invoice_flow_uid
        self.invoice_flow_name = invoice_flow_name
        self.flow_description = flow_description
        self.flow_definition_json = flow_definition_json
    def update_attributes(self, invoice_flow_name: str, flow_description: str, flow_definition_json: str):
        self.invoice_flow_name = invoice_flow_name
        self.flow_description = flow_description
        self.flow_definition_json = flow_definition_json
...
class invoice_flow_state_write_dto(base_write_dto):
    ...
    invoice_flow_uid: str
    def __init__(self, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str):
        return cls(invoice_flow_state_uid, invoice_flow_state_name, invoice_flow_uid)
    @classmethod
    def new_write_with_defaults(cls, invoice_flow_state_uid: str = "", invoice_flow_state_name: str = "", invoice_flow_uid: str = ""):
        return cls(invoice_flow_state_uid, invoice_flow_state_name, invoice_flow_uid)
    @classmethod
    def new_write_random_uid(cls, invoice_flow_state_name: str, invoice_flow_uid: str):
        return cls(base_dto.get_random_uid(), invoice_flow_state_name, invoice_flow_uid)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.invoice_flow_state_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["invoice_flow_state_uid"], d["invoice_flow_state_name"], d["invoice_flow_uid"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return invoice_flow_state_write_dto(base_dto.get_random_uid(), self.invoice_flow_state_name, self.invoice_flow_uid, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return invoice_flow_state_write_dto(uid, self.invoice_flow_state_name, self.invoice_flow_uid, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.invoice_flow_state_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.invoice_flow_state_uid, self.invoice_flow_state_name, self.invoice_flow_uid, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.invoice_flow_state_uid, self.invoice_flow_state_name, self.invoice_flow_uid]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.invoice_flow_state_name, self.invoice_flow_uid, self.custom_attributes, updated_by, self.invoice_flow_state_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.invoice_flow_state_uid, self.invoice_flow_state_name, self.invoice_flow_uid, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.invoice_flow_state_name, self.invoice_flow_uid]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.invoice_flow_state_name, self.invoice_flow_uid, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str):
        self.invoice_flow_state_uid = invoice_flow_state_uid
        self.invoice_flow_state_name = invoice_flow_state_name
        self.invoice_flow_uid = invoice_flow_uid
    def update_attributes(self, invoice_flow_state_name: str, invoice_flow_uid: str):
        self.invoice_flow_state_name = invoice_flow_state_name
        self.invoice_flow_uid = invoice_flow_uid
...
class monitor_run_write_dto(base_write_dto):
    ...
    def __init__(self, process_run_uid: str, process_run_name: str, tenant_uid: str, account_uid: str, monitor_uid: str, status_name: str, run_time: str, exception_message: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", base_dto.get_random_uid())
    @classmethod
    def new_write(cls, process_run_uid: str, process_run_name: str, tenant_uid: str, account_uid: str, monitor_uid: str, status_name: str, run_time: str, exception_message: str):
        return cls(process_run_uid, process_run_name, tenant_uid, account_uid, monitor_uid, status_name, run_time, exception_message)
    @classmethod
    def new_write_with_defaults(cls, process_run_uid: str = "", process_run_name: str = "", tenant_uid: str = "", account_uid: str = "", monitor_uid: str = "", status_name: str = "", run_time: str = "", exception_message: str = ""):
        return cls(process_run_uid, process_run_name, tenant_uid, account_uid, monitor_uid, status_name, run_time, exception_message)
    @classmethod
    def new_write_random_uid(cls, process_run_uid: str, process_run_name: str, tenant_uid: str, account_uid: str, monitor_uid: str, status_name: str, run_time: str, exception_message: str):
        return cls(base_dto.get_random_uid(), process_run_uid, process_run_name, tenant_uid, account_uid, monitor_uid, status_name, run_time, exception_message)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.monitor_run_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["process_run_uid"], d["process_run_name"], d["tenant_uid"], d["account_uid"], d["monitor_uid"], d["status_name"], d["run_time"], d["exception_message"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return monitor_run_write_dto(base_dto.get_random_uid(), self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return monitor_run_write_dto(uid, self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.monitor_run_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message]
    def get_list_write_update(self, updated_by: str) -> list[any]:
    ...
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.monitor_run_uid, self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.process_run_uid, self.process_run_name, self.tenant_uid, self.account_uid, self.monitor_uid, self.status_name, self.run_time, self.exception_message, self.custom_attributes]
    ...
    def update_uid_attributes(self, process_run_uid: str, process_run_name: str, tenant_uid: str, account_uid: str, monitor_uid: str, status_name: str, run_time: str, exception_message: str):
        self.process_run_uid = process_run_uid
        self.process_run_name = process_run_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        ...
        self.run_time = run_time
        self.exception_message = exception_message
    def update_attributes(self, process_run_uid: str, process_run_name: str, tenant_uid: str, account_uid: str, monitor_uid: str, status_name: str, run_time: str, exception_message: str):
        self.process_run_uid = process_run_uid
        self.process_run_name = process_run_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
...
class process_write_dto(base_write_dto):
    ...
    def __init__(self, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str):
        return cls(process_uid, process_name, tenant_uid, account_uid, process_type_uid)
    @classmethod
    def new_write_with_defaults(cls, process_uid: str = "", process_name: str = "", tenant_uid: str = "", account_uid: str = "", process_type_uid: str = ""):
        return cls(process_uid, process_name, tenant_uid, account_uid, process_type_uid)
    @classmethod
    def new_write_random_uid(cls, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str):
        return cls(base_dto.get_random_uid(), process_name, tenant_uid, account_uid, process_type_uid)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.process_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["process_uid"], d["process_name"], d["tenant_uid"], d["account_uid"], d["process_type_uid"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return process_write_dto(base_dto.get_random_uid(), self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return process_write_dto(uid, self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.process_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.process_uid, self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.process_uid, self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.custom_attributes, updated_by, self.process_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.process_uid, self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str):
        self.process_uid = process_uid
        self.process_name = process_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        self.process_type_uid = process_type_uid
    def update_attributes(self, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str):
        self.process_name = process_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        self.process_type_uid = process_type_uid
...
class process_run_write_dto(base_write_dto):
    ...
    account_uid: str
    process_uid: str
    def __init__(self, report_run_uid: str, report_run_name: str, tenant_uid: str, account_uid: str, process_uid: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, report_run_uid: str, report_run_name: str, tenant_uid: str, account_uid: str, process_uid: str):
        return cls(report_run_uid, report_run_name, tenant_uid, account_uid, process_uid)
    @classmethod
    def new_write_with_defaults(cls, report_run_uid: str = "", report_run_name: str = "", tenant_uid: str = "", account_uid: str = "", process_uid: str = ""):
        return cls(report_run_uid, report_run_name, tenant_uid, account_uid, process_uid)
    @classmethod
    def new_write_random_uid(cls, report_run_uid: str, report_run_name: str, tenant_uid: str, account_uid: str, process_uid: str):
        return cls(base_dto.get_random_uid(), report_run_uid, report_run_name, tenant_uid, account_uid, process_uid)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.process_run_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["report_run_uid"], d["report_run_name"], d["tenant_uid"], d["account_uid"], d["process_uid"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return process_run_write_dto(base_dto.get_random_uid(), self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return process_run_write_dto(uid, self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.process_run_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid]
    def get_list_write_update(self, updated_by: str) -> list[any]:
    ...
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.process_run_uid, self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.report_run_uid, self.report_run_name, self.tenant_uid, self.account_uid, self.process_uid, self.custom_attributes]
    ...
    def update_uid_attributes(self, report_run_uid: str, report_run_name: str, tenant_uid: str, account_uid: str, process_uid: str):
        self.report_run_uid = report_run_uid
        self.report_run_name = report_run_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
        self.process_uid = process_uid
    def update_attributes(self, report_run_uid: str, report_run_name: str, tenant_uid: str, account_uid: str, process_uid: str):
        self.report_run_uid = report_run_uid
        self.report_run_name = report_run_name
        self.tenant_uid = tenant_uid
        self.account_uid = account_uid
...
class report_format_write_dto(base_write_dto):
    ...
    def __init__(self, report_format_uid: str, report_format_name: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, report_format_uid: str, report_format_name: str):
        return cls(report_format_uid, report_format_name)
    @classmethod
    def new_write_with_defaults(cls, report_format_uid: str = "", report_format_name: str = ""):
        return cls(report_format_uid, report_format_name)
    @classmethod
    def new_write_random_uid(cls, report_format_name: str):
        return cls(base_dto.get_random_uid(), report_format_name)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.report_format_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["report_format_uid"], d["report_format_name"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
        return report_format_write_dto(self.report_format_uid, self.report_format_name, self.custom_attributes)
    def clone_write_new_uid(self):
        return report_format_write_dto(base_dto.get_random_uid(), self.report_format_name, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return report_format_write_dto(uid, self.report_format_name, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.report_format_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.report_format_uid, self.report_format_name, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.report_format_uid, self.report_format_name]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.report_format_name, self.custom_attributes, updated_by, self.report_format_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.report_format_uid, self.report_format_name, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.report_format_name]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.report_format_name, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, report_format_uid: str, report_format_name: str):
        self.report_format_uid = report_format_uid
        self.report_format_name = report_format_name
    def update_attributes(self, report_format_name: str):
        self.report_format_name = report_format_name
...
class storage_write_dto(base_write_dto):
    ...
    def __init__(self, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str):
        return cls(storage_uid, storage_name, storage_class, storage_parameters_json)
    @classmethod
    def new_write_with_defaults(cls, storage_uid: str = "", storage_name: str = "", storage_class: str = "", storage_parameters_json: str = ""):
        return cls(storage_uid, storage_name, storage_class, storage_parameters_json)
    @classmethod
    def new_write_random_uid(cls, storage_name: str, storage_class: str, storage_parameters_json: str):
        return cls(base_dto.get_random_uid(), storage_name, storage_class, storage_parameters_json)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.storage_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_uid"], d["storage_name"], d["storage_class"], d["storage_parameters_json"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return storage_write_dto(base_dto.get_random_uid(), self.storage_name, self.storage_class, self.storage_parameters_json, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return storage_write_dto(uid, self.storage_name, self.storage_class, self.storage_parameters_json, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.storage_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.storage_uid, self.storage_name, self.storage_class, self.storage_parameters_json, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.storage_uid, self.storage_name, self.storage_class, self.storage_parameters_json]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.storage_name, self.storage_class, self.storage_parameters_json, self.custom_attributes, updated_by, self.storage_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.storage_uid, self.storage_name, self.storage_class, self.storage_parameters_json, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.storage_name, self.storage_class, self.storage_parameters_json]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.storage_name, self.storage_class, self.storage_parameters_json, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str):
        self.storage_uid = storage_uid
        self.storage_name = storage_name
        self.storage_class = storage_class
        self.storage_parameters_json = storage_parameters_json
    def update_attributes(self, storage_name: str, storage_class: str, storage_parameters_json: str):
        self.storage_name = storage_name
        self.storage_class = storage_class
        self.storage_parameters_json = storage_parameters_json
...
class storage_query_write_dto(base_write_dto):
    ...
    storage_uid: str
    storage_parameters_json: str
    def __init__(self, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str, custom_attributes: str = "{}"):
        self.storage_connection_uid = storage_connection_uid
        self.storage_connection_name = storage_connection_name
        self.storage_uid = storage_uid
        self.storage_parameters_json = storage_parameters_json
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str):
        return cls(storage_connection_uid, storage_connection_name, storage_uid, storage_parameters_json)
    @classmethod
    def new_write_with_defaults(cls, storage_connection_uid: str = "", storage_connection_name: str = "", storage_uid: str = "", storage_parameters_json: str = ""):
        return cls(storage_connection_uid, storage_connection_name, storage_uid, storage_parameters_json)
    @classmethod
    def new_write_random_uid(cls, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str):
        return cls(base_dto.get_random_uid(), storage_connection_uid, storage_connection_name, storage_uid, storage_parameters_json)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.storage_query_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_connection_uid"], d["storage_connection_name"], d["storage_uid"], d["storage_parameters_json"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return storage_query_write_dto(base_dto.get_random_uid(), self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return storage_query_write_dto(uid, self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.storage_query_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.custom_attributes, updated_by, self.storage_query_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.storage_query_uid, self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.custom_attributes]
    ...
    def update_uid_attributes(self, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str):
        self.storage_connection_uid = storage_connection_uid
        self.storage_connection_name = storage_connection_name
        self.storage_uid = storage_uid
        self.storage_parameters_json = storage_parameters_json
    def update_attributes(self, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str):
        self.storage_connection_uid = storage_connection_uid
        self.storage_connection_name = storage_connection_name
        self.storage_uid = storage_uid
        self.storage_parameters_json = storage_parameters_json
...
class storage_type_write_dto(base_write_dto):
    ...
    storage_class: str
    storage_parameters_json: str
    def __init__(self, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str):
        return cls(storage_type_uid, storage_type_name, storage_class, storage_parameters_json)
    @classmethod
    def new_write_with_defaults(cls, storage_type_uid: str = "", storage_type_name: str = "", storage_class: str = "", storage_parameters_json: str = ""):
        return cls(storage_type_uid, storage_type_name, storage_class, storage_parameters_json)
    @classmethod
    def new_write_random_uid(cls, storage_type_name: str, storage_class: str, storage_parameters_json: str):
        return cls(base_dto.get_random_uid(), storage_type_name, storage_class, storage_parameters_json)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.storage_type_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_type_uid"], d["storage_type_name"], d["storage_class"], d["storage_parameters_json"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return storage_type_write_dto(base_dto.get_random_uid(), self.storage_type_name, self.storage_class, self.storage_parameters_json, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return storage_type_write_dto(uid, self.storage_type_name, self.storage_class, self.storage_parameters_json, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.storage_type_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.storage_type_uid, self.storage_type_name, self.storage_class, self.storage_parameters_json, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.storage_type_uid, self.storage_type_name, self.storage_class, self.storage_parameters_json]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.storage_type_name, self.storage_class, self.storage_parameters_json, self.custom_attributes, updated_by, self.storage_type_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.storage_type_uid, self.storage_type_name, self.storage_class, self.storage_parameters_json, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.storage_type_name, self.storage_class, self.storage_parameters_json]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.storage_type_name, self.storage_class, self.storage_parameters_json, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str):
        self.storage_type_uid = storage_type_uid
        self.storage_type_name = storage_type_name
        self.storage_class = storage_class
        self.storage_parameters_json = storage_parameters_json
    def update_attributes(self, storage_type_name: str, storage_class: str, storage_parameters_json: str):
        self.storage_type_name = storage_type_name
        self.storage_class = storage_class
        self.storage_parameters_json = storage_parameters_json
...
class synchronization_run_write_dto(base_write_dto):
    ...
    copied_items: int
    def __init__(self, synchronization_run_uid: str, synchronization_run_name: str, synchronization_uid: int, run_status: str, run_time_seconds: str, copied_items: int, custom_attributes: str = "{}"):
    ...
    @classmethod
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), 0, base_dto.get_random_uid(), base_dto.get_random_uid(), 0)
    @classmethod
    def new_write(cls, synchronization_run_uid: str, synchronization_run_name: str, synchronization_uid: int, run_status: str, run_time_seconds: str, copied_items: int):
        return cls(synchronization_run_uid, synchronization_run_name, synchronization_uid, run_status, run_time_seconds, copied_items)
    @classmethod
    def new_write_with_defaults(cls, synchronization_run_uid: str = "", synchronization_run_name: str = "", synchronization_uid: int = 0, run_status: str = "", run_time_seconds: str = "", copied_items: int = 0):
        return cls(synchronization_run_uid, synchronization_run_name, synchronization_uid, run_status, run_time_seconds, copied_items)
    @classmethod
    def new_write_random_uid(cls, synchronization_run_name: str, synchronization_uid: int, run_status: str, run_time_seconds: str, copied_items: int):
    ...
    def update_uid_attributes(self, synchronization_run_uid: str, synchronization_run_name: str, synchronization_uid: int, run_status: str, run_time_seconds: str, copied_items: int):
        self.synchronization_run_uid = synchronization_run_uid
        self.synchronization_run_name = synchronization_run_name
        self.synchronization_uid = synchronization_uid
        self.run_status = run_status
        self.run_time_seconds = run_time_seconds
        self.copied_items = copied_items
    def update_attributes(self, synchronization_run_name: str, synchronization_uid: int, run_status: str, run_time_seconds: str, copied_items: int):
        self.synchronization_run_name = synchronization_run_name
        self.synchronization_uid = synchronization_uid
        self.run_status = run_status
        self.run_time_seconds = run_time_seconds
...
class synchronization_type_write_dto(base_write_dto):
    ...
    sync_type: str
    sync_class_came: str
    def __init__(self, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str, custom_attributes: str = "{}"):
        self.synchronization_type_uid = synchronization_type_uid
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), "", "")
    @classmethod
    def new_write(cls, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str):
        return cls(synchronization_type_uid, synchronization_type_name, sync_type, sync_class_came)
    @classmethod
    def new_write_with_defaults(cls, synchronization_type_uid: str = "", synchronization_type_name: str = "", sync_type: str = "", sync_class_came: str = ""):
        return cls(synchronization_type_uid, synchronization_type_name, sync_type, sync_class_came)
    @classmethod
    def new_write_random_uid(cls, synchronization_type_name: str, sync_type: str, sync_class_came: str):
        return cls(base_dto.get_random_uid(), synchronization_type_name, sync_type, sync_class_came)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.synchronization_type_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["synchronization_type_uid"], d["synchronization_type_name"], d["sync_type"], d["sync_class_came"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return synchronization_type_write_dto(base_dto.get_random_uid(), self.synchronization_type_name, self.sync_type, self.sync_class_came, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return synchronization_type_write_dto(uid, self.synchronization_type_name, self.sync_type, self.sync_class_came, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.synchronization_type_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.synchronization_type_uid, self.synchronization_type_name, self.sync_type, self.sync_class_came, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.synchronization_type_uid, self.synchronization_type_name, self.sync_type, self.sync_class_came]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.synchronization_type_name, self.sync_type, self.sync_class_came, self.custom_attributes, updated_by, self.synchronization_type_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.synchronization_type_uid, self.synchronization_type_name, self.sync_type, self.sync_class_came, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.synchronization_type_name, self.sync_type, self.sync_class_came]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.synchronization_type_name, self.sync_type, self.sync_class_came, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str):
        self.synchronization_type_uid = synchronization_type_uid
        self.synchronization_type_name = synchronization_type_name
        self.sync_type = sync_type
        self.sync_class_came = sync_class_came
    def update_attributes(self, synchronization_type_name: str, sync_type: str, sync_class_came: str):
        self.synchronization_type_name = synchronization_type_name
        self.sync_type = sync_type
        self.sync_class_came = sync_class_came
...
class system_attribute_write_dto(base_write_dto):
    ...
    def __init__(self, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str):
        return cls(system_attribute_uid, system_attribute_name, system_object_uid, column_name, attribute_type, attribute_label, attribute_description)
    @classmethod
    def new_write_with_defaults(cls, system_attribute_uid: str = "", system_attribute_name: str = "", system_object_uid: str = "", column_name: str = "", attribute_type: str = "", attribute_label: str = "", attribute_description: str = ""):
        return cls(system_attribute_uid, system_attribute_name, system_object_uid, column_name, attribute_type, attribute_label, attribute_description)
    @classmethod
    def new_write_random_uid(cls, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str):
        return cls(base_dto.get_random_uid(), system_attribute_name, system_object_uid, column_name, attribute_type, attribute_label, attribute_description)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_attribute_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_attribute_uid"], d["system_attribute_name"], d["system_object_uid"], d["column_name"], d["attribute_type"], d["attribute_label"], d["attribute_description"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_attribute_write_dto(base_dto.get_random_uid(), self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_attribute_write_dto(uid, self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_attribute_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_attribute_uid, self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_attribute_uid, self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, self.custom_attributes, updated_by, self.system_attribute_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_attribute_uid, self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_attribute_name, self.system_object_uid, self.column_name, self.attribute_type, self.attribute_label, self.attribute_description, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str):
        self.system_attribute_uid = system_attribute_uid
        self.system_attribute_name = system_attribute_name
        self.system_object_uid = system_object_uid
        self.column_name = column_name
        ...
        self.attribute_label = attribute_label
        self.attribute_description = attribute_description
    def update_attributes(self, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str):
        self.system_attribute_name = system_attribute_name
        self.system_object_uid = system_object_uid
        self.column_name = column_name
        self.attribute_type = attribute_type
...
class system_database_write_dto(base_write_dto):
    ...
    db_name: str
    db_user: str
    def __init__(self, system_database_uid: str, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_database_uid: str, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str):
        return cls(system_database_uid, system_database_name, db_url, db_host, db_name, db_user)
    @classmethod
    def new_write_with_defaults(cls, system_database_uid: str = "", system_database_name: str = "", db_url: str = "", db_host: str = "", db_name: str = "", db_user: str = ""):
        return cls(system_database_uid, system_database_name, db_url, db_host, db_name, db_user)
    @classmethod
    def new_write_random_uid(cls, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str):
        return cls(base_dto.get_random_uid(), system_database_name, db_url, db_host, db_name, db_user)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_database_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_database_uid"], d["system_database_name"], d["db_url"], d["db_host"], d["db_name"], d["db_user"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_database_write_dto(base_dto.get_random_uid(), self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_database_write_dto(uid, self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_database_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_database_uid, self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_database_uid, self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, self.custom_attributes, updated_by, self.system_database_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_database_uid, self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_database_name, self.db_url, self.db_host, self.db_name, self.db_user, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_database_uid: str, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str):
        self.system_database_uid = system_database_uid
        self.system_database_name = system_database_name
        self.db_url = db_url
        self.db_host = db_host
        self.db_name = db_name
        self.db_user = db_user
    def update_attributes(self, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str):
        self.system_database_name = system_database_name
        self.db_url = db_url
        self.db_host = db_host
        self.db_name = db_name
...
class system_license_write_dto(base_write_dto):
    ...
    def __init__(self, system_license_uid: str, system_license_name: str, license_description: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_license_uid: str, system_license_name: str, license_description: str):
        return cls(system_license_uid, system_license_name, license_description)
    @classmethod
    def new_write_with_defaults(cls, system_license_uid: str = "", system_license_name: str = "", license_description: str = ""):
        return cls(system_license_uid, system_license_name, license_description)
    @classmethod
    def new_write_random_uid(cls, system_license_name: str, license_description: str):
        return cls(base_dto.get_random_uid(), system_license_name, license_description)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_license_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_license_uid"], d["system_license_name"], d["license_description"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_license_write_dto(base_dto.get_random_uid(), self.system_license_name, self.license_description, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_license_write_dto(uid, self.system_license_name, self.license_description, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_license_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_license_uid, self.system_license_name, self.license_description, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_license_uid, self.system_license_name, self.license_description]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_license_name, self.license_description, self.custom_attributes, updated_by, self.system_license_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_license_uid, self.system_license_name, self.license_description, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_license_name, self.license_description]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_license_name, self.license_description, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_license_uid: str, system_license_name: str, license_description: str):
        self.system_license_uid = system_license_uid
        self.system_license_name = system_license_name
        self.license_description = license_description
    def update_attributes(self, system_license_name: str, license_description: str):
        self.system_license_name = system_license_name
        self.license_description = license_description
...
class system_lock_write_dto(base_write_dto):
    ...
    lock_comment: str
    def __init__(self, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str):
        return cls(system_lock_uid, system_lock_name, lock_account_uid, lock_comment)
    @classmethod
    def new_write_with_defaults(cls, system_lock_uid: str = "", system_lock_name: str = "", lock_account_uid: str = "", lock_comment: str = ""):
        return cls(system_lock_uid, system_lock_name, lock_account_uid, lock_comment)
    @classmethod
    def new_write_random_uid(cls, system_lock_name: str, lock_account_uid: str, lock_comment: str):
        return cls(base_dto.get_random_uid(), system_lock_name, lock_account_uid, lock_comment)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_lock_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_lock_uid"], d["system_lock_name"], d["lock_account_uid"], d["lock_comment"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_lock_write_dto(base_dto.get_random_uid(), self.system_lock_name, self.lock_account_uid, self.lock_comment, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_lock_write_dto(uid, self.system_lock_name, self.lock_account_uid, self.lock_comment, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_lock_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_lock_uid, self.system_lock_name, self.lock_account_uid, self.lock_comment, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_lock_uid, self.system_lock_name, self.lock_account_uid, self.lock_comment]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_lock_name, self.lock_account_uid, self.lock_comment, self.custom_attributes, updated_by, self.system_lock_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_lock_uid, self.system_lock_name, self.lock_account_uid, self.lock_comment, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_lock_name, self.lock_account_uid, self.lock_comment]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_lock_name, self.lock_account_uid, self.lock_comment, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str):
        self.system_lock_uid = system_lock_uid
        self.system_lock_name = system_lock_name
        self.lock_account_uid = lock_account_uid
        self.lock_comment = lock_comment
    def update_attributes(self, system_lock_name: str, lock_account_uid: str, lock_comment: str):
        self.system_lock_name = system_lock_name
        self.lock_account_uid = lock_account_uid
        self.lock_comment = lock_comment
...
class system_object_write_dto(base_write_dto):
    ...
    object_type: str
    def __init__(self, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str, custom_attributes: str = "{}"):
        self.system_object_uid = system_object_uid
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str):
        return cls(system_object_uid, system_object_name, system_version_uid, system_table_uid, system_object_type_uid, parent_system_object_uid, object_type)
    @classmethod
    def new_write_with_defaults(cls, system_object_uid: str = "", system_object_name: str = "", system_version_uid: str = objects.system_version_uid, system_table_uid: str = "", system_object_type_uid: str = "", parent_system_object_uid: str | None = "", object_type: str = ""):
        return cls(system_object_uid, system_object_name, system_version_uid, system_table_uid, system_object_type_uid, parent_system_object_uid, object_type)
    @classmethod
    def new_write_random_uid(cls, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str):
        return cls(base_dto.get_random_uid(), system_object_name, system_version_uid, system_table_uid, system_object_type_uid, parent_system_object_uid, object_type)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_object_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_object_uid"], d["system_object_name"], d["system_version_uid"], d["system_table_uid"], d["system_object_type_uid"], d["parent_system_object_uid"], d["object_type"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_object_write_dto(base_dto.get_random_uid(), self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_object_write_dto(uid, self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_object_model
    def get_uid(self) -> str:
        return self.system_object_uid
    def get_name(self) -> str:
        return self.system_object_name
    def get_list_values(self) -> list[any]:
        return [self.system_object_uid, self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_object_uid, self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.custom_attributes, updated_by, self.system_object_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_object_uid, self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str):
        self.system_object_uid = system_object_uid
        self.system_object_name = system_object_name
        self.system_version_uid = system_version_uid
        self.system_table_uid = system_table_uid
        ...
        self.parent_system_object_uid = parent_system_object_uid
        self.object_type = object_type
    def update_attributes(self, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str):
        self.system_object_name = system_object_name
        self.system_version_uid = system_version_uid
        self.system_table_uid = system_table_uid
        self.system_object_type_uid = system_object_type_uid
...
@dataclass(frozen=False)
class system_object_type_write_dto(base_write_dto):
    system_object_type_uid: str
    system_object_type_name: str
    object_type_description: str
    def __init__(self, system_object_type_uid: str, system_object_type_name: str, object_type_description: str, custom_attributes: str = "{}"):
        self.system_object_type_uid = system_object_type_uid
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_object_type_uid: str, system_object_type_name: str, object_type_description: str):
        return cls(system_object_type_uid, system_object_type_name, object_type_description)
    @classmethod
    def new_write_with_defaults(cls, system_object_type_uid: str = "", system_object_type_name: str = "", object_type_description: str = ""):
        return cls(system_object_type_uid, system_object_type_name, object_type_description)
    @classmethod
    def new_write_random_uid(cls, system_object_type_name: str, object_type_description: str):
        return cls(base_dto.get_random_uid(), system_object_type_name, object_type_description)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_object_type_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_object_type_uid"], d["system_object_type_name"], d["object_type_description"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_object_type_write_dto(base_dto.get_random_uid(), self.system_object_type_name, self.object_type_description, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_object_type_write_dto(uid, self.system_object_type_name, self.object_type_description, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_object_type_model
    def get_uid(self) -> str:
        return self.system_object_type_uid
    def get_name(self) -> str:
        return self.system_object_type_name
    def get_list_values(self) -> list[any]:
        return [self.system_object_type_uid, self.system_object_type_name, self.object_type_description, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_object_type_uid, self.system_object_type_name, self.object_type_description]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_object_type_name, self.object_type_description, self.custom_attributes, updated_by, self.system_object_type_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_object_type_uid, self.system_object_type_name, self.object_type_description, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_object_type_name, self.object_type_description]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_object_type_name, self.object_type_description, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    def update_uid(self, uid: str):
        self.system_object_type_uid = uid
    def update_uid_attributes(self, system_object_type_uid: str, system_object_type_name: str, object_type_description: str):
        self.system_object_type_uid = system_object_type_uid
        self.system_object_type_name = system_object_type_name
        self.object_type_description = object_type_description
    def update_attributes(self, system_object_type_name: str, object_type_description: str):
        self.system_object_type_name = system_object_type_name
        self.object_type_description = object_type_description
...
class system_setting_write_dto(base_write_dto):
    ...
    setting_value: str
    def __init__(self, system_setting_uid: str, system_setting_name: str, setting_value: str, custom_attributes: str = "{}"):
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_setting_uid: str, system_setting_name: str, setting_value: str):
        return cls(system_setting_uid, system_setting_name, setting_value)
    @classmethod
    def new_write_with_defaults(cls, system_setting_uid: str = "", system_setting_name: str = "", setting_value: str = ""):
        return cls(system_setting_uid, system_setting_name, setting_value)
    @classmethod
    def new_write_random_uid(cls, system_setting_name: str, setting_value: str):
        return cls(base_dto.get_random_uid(), system_setting_name, setting_value)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_setting_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_setting_uid"], d["system_setting_name"], d["setting_value"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_setting_write_dto(base_dto.get_random_uid(), self.system_setting_name, self.setting_value, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_setting_write_dto(uid, self.system_setting_name, self.setting_value, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_setting_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_setting_uid, self.system_setting_name, self.setting_value, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_setting_uid, self.system_setting_name, self.setting_value]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_setting_name, self.setting_value, self.custom_attributes, updated_by, self.system_setting_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_setting_uid, self.system_setting_name, self.setting_value, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_setting_name, self.setting_value]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_setting_name, self.setting_value, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_setting_uid: str, system_setting_name: str, setting_value: str):
        self.system_setting_uid = system_setting_uid
        self.system_setting_name = system_setting_name
        self.setting_value = setting_value
    def update_attributes(self, system_setting_name: str, setting_value: str):
        self.system_setting_name = system_setting_name
        self.setting_value = setting_value
...
class system_table_write_dto(base_write_dto):
    ...
    table_code: str
    table_comment: str
    def __init__(self, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str, custom_attributes: str = "{}"):
        self.system_table_uid = system_table_uid
    ...
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid())
    @classmethod
    def new_write(cls, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str):
        return cls(system_table_uid, system_table_name, parent_system_table_uid, key_name, table_code, table_comment)
    @classmethod
    def new_write_with_defaults(cls, system_table_uid: str = "", system_table_name: str = "", parent_system_table_uid: str | None = "", key_name: str = "", table_code: str = "", table_comment: str = ""):
        return cls(system_table_uid, system_table_name, parent_system_table_uid, key_name, table_code, table_comment)
    @classmethod
    def new_write_random_uid(cls, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str):
        return cls(base_dto.get_random_uid(), system_table_name, parent_system_table_uid, key_name, table_code, table_comment)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_table_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_table_uid"], d["system_table_name"], d["parent_system_table_uid"], d["key_name"], d["table_code"], d["table_comment"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_table_write_dto(base_dto.get_random_uid(), self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_table_write_dto(uid, self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_table_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_table_uid, self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_table_uid, self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.custom_attributes, updated_by, self.system_table_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_table_uid, self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str):
        self.system_table_uid = system_table_uid
        self.system_table_name = system_table_name
        self.parent_system_table_uid = parent_system_table_uid
        self.key_name = key_name
        self.table_code = table_code
        self.table_comment = table_comment
    def update_attributes(self, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str):
        self.system_table_name = system_table_name
        self.parent_system_table_uid = parent_system_table_uid
        self.key_name = key_name
        self.table_code = table_code
...
class system_thread_write_dto(base_write_dto):
    ...
    ticks_count: int
    sleep_time: int
    def __init__(self, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int, custom_attributes: str = "{}"):
    ...
    @classmethod
    def random_write(cls):
        return cls(base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0, 0)
    @classmethod
    def new_write(cls, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int):
        return cls(system_thread_uid, system_thread_name, thread_name, parent_object, ticks_count, sleep_time)
    @classmethod
    def new_write_with_defaults(cls, system_thread_uid: str = "", system_thread_name: str = "", thread_name: str = "", parent_object: str = "", ticks_count: int = 0, sleep_time: int = 0):
        return cls(system_thread_uid, system_thread_name, thread_name, parent_object, ticks_count, sleep_time)
    @classmethod
    def new_write_random_uid(cls, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int):
        return cls(base_dto.get_random_uid(), system_thread_name, thread_name, parent_object, ticks_count, sleep_time)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.system_thread_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_thread_uid"], d["system_thread_name"], d["thread_name"], d["parent_object"], d["ticks_count"], d["sleep_time"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return system_thread_write_dto(base_dto.get_random_uid(), self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return system_thread_write_dto(uid, self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.system_thread_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.system_thread_uid, self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.system_thread_uid, self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.custom_attributes, updated_by, self.system_thread_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.system_thread_uid, self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int):
        self.system_thread_uid = system_thread_uid
        self.system_thread_name = system_thread_name
        self.thread_name = thread_name
        self.parent_object = parent_object
        self.ticks_count = ticks_count
        self.sleep_time = sleep_time
    def update_attributes(self, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int):
        self.system_thread_name = system_thread_name
        self.thread_name = thread_name
        self.parent_object = parent_object
        self.ticks_count = ticks_count
...
class tenant_license_write_dto(base_write_dto):
    ...
    end_date: datetime.datetime
    is_approved: int
    def __init__(self, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int, custom_attributes: str = "{}"):
    ...
    @classmethod
    def new_write(cls, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int):
        return cls(tenant_license_uid, tenant_license_name, tenant_uid, system_license_uid, start_date, end_date, is_approved)
    @classmethod
    def new_write_with_defaults(cls, tenant_license_uid: str = "", tenant_license_name: str = "", tenant_uid: str = "", system_license_uid: str = "", start_date: datetime.datetime = datetime.datetime.now(), end_date: datetime.datetime = datetime.datetime.now(), is_approved: int = 0):
        return cls(tenant_license_uid, tenant_license_name, tenant_uid, system_license_uid, start_date, end_date, is_approved)
    @classmethod
    def new_write_random_uid(cls, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int):
        return cls(base_dto.get_random_uid(), tenant_license_name, tenant_uid, system_license_uid, start_date, end_date, is_approved)
    @classmethod
    def get_class_model(cls) -> base_model:
        return db_models.tenant_license_model
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["tenant_license_uid"], d["tenant_license_name"], d["tenant_uid"], d["system_license_uid"], d["start_date"], d["end_date"], d["is_approved"])
    def to_write_dict(self) -> dict:
        return asdict(self)
    def clone_write(self):
    ...
    def clone_write_new_uid(self):
        return tenant_license_write_dto(base_dto.get_random_uid(), self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, self.custom_attributes)
    def clone_with_uid(self, uid: str):
        return tenant_license_write_dto(uid, self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, self.custom_attributes)
    def get_model(self) -> base_model:
        return db_models.tenant_license_model
    def get_uid(self) -> str:
    ...
    def get_list_values(self) -> list[any]:
        return [self.tenant_license_uid, self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, self.custom_attributes]
    def get_list_values_no_custom(self) -> list[any]:
        return [self.tenant_license_uid, self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved]
    def get_list_write_update(self, updated_by: str) -> list[any]:
        return [self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, self.custom_attributes, updated_by, self.tenant_license_uid]
    def get_list_write_insert(self, created_by: str) -> list[any]:
        return [self.tenant_license_uid, self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, created_by, created_by, self.custom_attributes]
    def get_nonkey_values(self) -> list[any]:
        return [self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved]
    def get_nonkey_values_with_custom(self) -> list[any]:
        return [self.tenant_license_name, self.tenant_uid, self.system_license_uid, self.start_date, self.end_date, self.is_approved, self.custom_attributes]
    def to_json_write(self) -> str:
        return json.dumps(self.to_write_dict())
    def compare_uid(self, obj: base_write_dto) -> bool:
        return self.get_uid() == obj.get_uid()
    ...
    def update_uid_attributes(self, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int):
        self.tenant_license_uid = tenant_license_uid
        self.tenant_license_name = tenant_license_name
        self.tenant_uid = tenant_uid
        self.system_license_uid = system_license_uid
        ...
        self.end_date = end_date
        self.is_approved = is_approved
    def update_attributes(self, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int):
        self.tenant_license_name = tenant_license_name
        self.tenant_uid = tenant_uid
        self.system_license_uid = system_license_uid
        self.start_date = start_date
