# auto-generated - v_definition_python_dtos_thin - START
import datetime
...
class system_object_thin_dto(base_dto):
    ...
    created_date: datetime.datetime
    is_active: int
    def __init__(self, system_object_uid: str,system_object_name: str, created_date: datetime.datetime, is_active: int):
...
class system_object_type_thin_dto(base_dto):
    ...
    created_date: datetime.datetime
    is_active: int
    def __init__(self, system_object_type_uid: str,system_object_type_name: str, created_date: datetime.datetime, is_active: int):
