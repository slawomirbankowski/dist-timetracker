...
class account_division_read_dto(base_read_dto, account_division_write_dto):
    ...
    def __init__(self, id: int , account_division_uid: str , system_version_uid: str , division_name: str , division_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def new_read_default(cls, account_division_uid: str , system_version_uid: str , division_name: str , division_description: str ):
        return cls(0, account_division_uid, system_version_uid, division_name, division_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , account_division_uid: str , system_version_uid: str , division_name: str , division_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, account_division_uid, system_version_uid, division_name, division_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_division_write_dto):
        return cls(0, dto.account_division_uid, dto.system_version_uid, dto.division_name, dto.division_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_division_read_dto(self.id, self.account_division_uid, self.system_version_uid, self.division_name, self.division_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["account_division_uid"], d["system_version_uid"], d["division_name"], d["division_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    ...
    def to_thin(self) -> account_division_thin_dto:
        return account_division_thin_dto(self.account_division_uid, self.created_date, self.is_active)
    ...
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.account_division_uid, self.system_version_uid, self.division_name, self.division_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
...
class account_group_read_dto(base_read_dto, account_group_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , account_group_uid: str , system_version_uid: str , account_group_name: str , account_group_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, account_group_uid: str , system_version_uid: str , account_group_name: str , account_group_description: str ):
        return cls(0, account_group_uid, system_version_uid, account_group_name, account_group_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , account_group_uid: str , system_version_uid: str , account_group_name: str , account_group_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, account_group_uid, system_version_uid, account_group_name, account_group_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_group_write_dto):
        return cls(0, dto.account_group_uid, dto.system_version_uid, dto.account_group_name, dto.account_group_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_group_read_dto(self.id, self.account_group_uid, self.system_version_uid, self.account_group_name, self.account_group_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["account_group_uid"], d["system_version_uid"], d["account_group_name"], d["account_group_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> account_group_thin_dto:
        return account_group_thin_dto(self.account_group_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.account_group_uid, self.system_version_uid, self.account_group_name, self.account_group_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class account_instance_read_dto(base_read_dto, account_instance_write_dto):
    ...
    @classmethod
    def new_read_default(cls, account_instance_uid: str , client_instance_uid: str , account_type_uid: str , account_title_uid: str , account_division_uid: str , account_group_uid: str , auth_identity_uid: str , account_email: str , account_name: str , display_name: str , is_system: int ):
        return cls(0, account_instance_uid, client_instance_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, account_name, display_name, is_system, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , account_instance_uid: str , client_instance_uid: str , account_type_uid: str , account_title_uid: str , account_division_uid: str , account_group_uid: str , auth_identity_uid: str , account_email: str , account_name: str , display_name: str , is_system: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, account_instance_uid, client_instance_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, account_name, display_name, is_system, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_instance_write_dto):
        return cls(0, dto.account_instance_uid, dto.client_instance_uid, dto.account_type_uid, dto.account_title_uid, dto.account_division_uid, dto.account_group_uid, dto.auth_identity_uid, dto.account_email, dto.account_name, dto.display_name, dto.is_system, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_instance_read_dto(self.id, self.account_instance_uid, self.client_instance_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.account_name, self.display_name, self.is_system, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["account_instance_uid"], d["client_instance_uid"], d["account_type_uid"], d["account_title_uid"], d["account_division_uid"], d["account_group_uid"], d["auth_identity_uid"], d["account_email"], d["account_name"], d["display_name"], d["is_system"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> account_instance_thin_dto:
        return account_instance_thin_dto(self.account_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.account_instance_uid, self.client_instance_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.account_name, self.display_name, self.is_system, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class account_title_read_dto(base_read_dto, account_title_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, account_title_uid: str , system_version_uid: str , title_name: str , title_description: str ):
        return cls(0, account_title_uid, system_version_uid, title_name, title_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , account_title_uid: str , system_version_uid: str , title_name: str , title_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, account_title_uid, system_version_uid, title_name, title_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_title_write_dto):
        return cls(0, dto.account_title_uid, dto.system_version_uid, dto.title_name, dto.title_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_title_read_dto(self.id, self.account_title_uid, self.system_version_uid, self.title_name, self.title_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["account_title_uid"], d["system_version_uid"], d["title_name"], d["title_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> account_title_thin_dto:
        return account_title_thin_dto(self.account_title_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.account_title_uid, self.system_version_uid, self.title_name, self.title_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class account_type_read_dto(base_read_dto, account_type_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , account_type_uid: str , system_version_uid: str , account_type_name: str , account_type_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
        self.account_type_uid = account_type_uid
        self.system_version_uid = system_version_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, account_type_uid: str , system_version_uid: str , account_type_name: str , account_type_description: str ):
        return cls(0, account_type_uid, system_version_uid, account_type_name, account_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , account_type_uid: str , system_version_uid: str , account_type_name: str , account_type_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, account_type_uid, system_version_uid, account_type_name, account_type_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_type_write_dto):
        return cls(0, dto.account_type_uid, dto.system_version_uid, dto.account_type_name, dto.account_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_type_read_dto(self.id, self.account_type_uid, self.system_version_uid, self.account_type_name, self.account_type_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["account_type_uid"], d["system_version_uid"], d["account_type_name"], d["account_type_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> account_type_thin_dto:
        return account_type_thin_dto(self.account_type_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.account_type_uid, self.system_version_uid, self.account_type_name, self.account_type_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class auth_identity_read_dto(base_read_dto, auth_identity_write_dto):
    ...
    @classmethod
    def new_read_default(cls, auth_identity_uid: str , client_instance_uid: str , identity_name: str , identity_type: str , identity_parameters: str , last_status_name: str ):
        return cls(0, auth_identity_uid, client_instance_uid, identity_name, identity_type, identity_parameters, last_status_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , auth_identity_uid: str , client_instance_uid: str , identity_name: str , identity_type: str , identity_parameters: str , last_status_name: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, auth_identity_uid, client_instance_uid, identity_name, identity_type, identity_parameters, last_status_name, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_identity_write_dto):
        return cls(0, dto.auth_identity_uid, dto.client_instance_uid, dto.identity_name, dto.identity_type, dto.identity_parameters, dto.last_status_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_identity_read_dto(self.id, self.auth_identity_uid, self.client_instance_uid, self.identity_name, self.identity_type, self.identity_parameters, self.last_status_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["auth_identity_uid"], d["client_instance_uid"], d["identity_name"], d["identity_type"], d["identity_parameters"], d["last_status_name"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> auth_identity_thin_dto:
        return auth_identity_thin_dto(self.auth_identity_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.auth_identity_uid, self.client_instance_uid, self.identity_name, self.identity_type, self.identity_parameters, self.last_status_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class auth_password_read_dto(base_read_dto, auth_password_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , auth_password_uid: str , account_instance_uid: str , system_instance_uid: str , password_hash: str , password_salt: str , date_from: datetime.datetime , date_to: datetime.datetime , usage_count: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), datetime.datetime.now(), datetime.datetime.now(), 0, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, auth_password_uid: str , account_instance_uid: str , system_instance_uid: str , password_hash: str , password_salt: str , date_from: datetime.datetime , date_to: datetime.datetime , usage_count: int ):
        return cls(0, auth_password_uid, account_instance_uid, system_instance_uid, password_hash, password_salt, date_from, date_to, usage_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , auth_password_uid: str , account_instance_uid: str , system_instance_uid: str , password_hash: str , password_salt: str , date_from: datetime.datetime , date_to: datetime.datetime , usage_count: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, auth_password_uid, account_instance_uid, system_instance_uid, password_hash, password_salt, date_from, date_to, usage_count, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_password_write_dto):
        return cls(0, dto.auth_password_uid, dto.account_instance_uid, dto.system_instance_uid, dto.password_hash, dto.password_salt, dto.date_from, dto.date_to, dto.usage_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_password_read_dto(self.id, self.auth_password_uid, self.account_instance_uid, self.system_instance_uid, self.password_hash, self.password_salt, self.date_from, self.date_to, self.usage_count, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["auth_password_uid"], d["account_instance_uid"], d["system_instance_uid"], d["password_hash"], d["password_salt"], d["date_from"], d["date_to"], d["usage_count"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> auth_password_thin_dto:
        return auth_password_thin_dto(self.auth_password_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.auth_password_uid, self.account_instance_uid, self.system_instance_uid, self.password_hash, self.password_salt, self.date_from, self.date_to, self.usage_count, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class auth_permission_read_dto(base_read_dto, auth_permission_write_dto):
    ...
    @classmethod
    def new_read_default(cls, auth_permission_uid: str , account_instance_uid: str , system_instance_uid: str , auth_role_uid: str , client_instance_uid: str  | None, project_instance_uid: str  | None, valid_from_date: datetime.datetime , valid_till_date: datetime.datetime ):
        return cls(0, auth_permission_uid, account_instance_uid, system_instance_uid, auth_role_uid, client_instance_uid, project_instance_uid, valid_from_date, valid_till_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , auth_permission_uid: str , account_instance_uid: str , system_instance_uid: str , auth_role_uid: str , client_instance_uid: str  | None, project_instance_uid: str  | None, valid_from_date: datetime.datetime , valid_till_date: datetime.datetime , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, auth_permission_uid, account_instance_uid, system_instance_uid, auth_role_uid, client_instance_uid, project_instance_uid, valid_from_date, valid_till_date, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_permission_write_dto):
        return cls(0, dto.auth_permission_uid, dto.account_instance_uid, dto.system_instance_uid, dto.auth_role_uid, dto.client_instance_uid, dto.project_instance_uid, dto.valid_from_date, dto.valid_till_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_permission_read_dto(self.id, self.auth_permission_uid, self.account_instance_uid, self.system_instance_uid, self.auth_role_uid, self.client_instance_uid, self.project_instance_uid, self.valid_from_date, self.valid_till_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["auth_permission_uid"], d["account_instance_uid"], d["system_instance_uid"], d["auth_role_uid"], d["client_instance_uid"], d["project_instance_uid"], d["valid_from_date"], d["valid_till_date"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> auth_permission_thin_dto:
        return auth_permission_thin_dto(self.auth_permission_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.auth_permission_uid, self.account_instance_uid, self.system_instance_uid, self.auth_role_uid, self.client_instance_uid, self.project_instance_uid, self.valid_from_date, self.valid_till_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class auth_request_read_dto(base_read_dto, auth_request_write_dto):
    ...
    @classmethod
    def new_read_default(cls, auth_request_uid: str , by_account_instance_uid: str , account_instance_uid: str , system_instance_uid: str , reset_guid: str , valid_till_date: datetime.datetime , lock_guid: str  | None, lock_by: str  | None, lock_date: datetime.datetime  | None, is_checked: int , is_used: int , check_date: datetime.datetime  | None, use_date: datetime.datetime  | None):
        return cls(0, auth_request_uid, by_account_instance_uid, account_instance_uid, system_instance_uid, reset_guid, valid_till_date, lock_guid, lock_by, lock_date, is_checked, is_used, check_date, use_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , auth_request_uid: str , by_account_instance_uid: str , account_instance_uid: str , system_instance_uid: str , reset_guid: str , valid_till_date: datetime.datetime , lock_guid: str  | None, lock_by: str  | None, lock_date: datetime.datetime  | None, is_checked: int , is_used: int , check_date: datetime.datetime  | None, use_date: datetime.datetime  | None, row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, auth_request_uid, by_account_instance_uid, account_instance_uid, system_instance_uid, reset_guid, valid_till_date, lock_guid, lock_by, lock_date, is_checked, is_used, check_date, use_date, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_request_write_dto):
        return cls(0, dto.auth_request_uid, dto.by_account_instance_uid, dto.account_instance_uid, dto.system_instance_uid, dto.reset_guid, dto.valid_till_date, dto.lock_guid, dto.lock_by, dto.lock_date, dto.is_checked, dto.is_used, dto.check_date, dto.use_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_request_read_dto(self.id, self.auth_request_uid, self.by_account_instance_uid, self.account_instance_uid, self.system_instance_uid, self.reset_guid, self.valid_till_date, self.lock_guid, self.lock_by, self.lock_date, self.is_checked, self.is_used, self.check_date, self.use_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["auth_request_uid"], d["by_account_instance_uid"], d["account_instance_uid"], d["system_instance_uid"], d["reset_guid"], d["valid_till_date"], d["lock_guid"], d["lock_by"], d["lock_date"], d["is_checked"], d["is_used"], d["check_date"], d["use_date"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> auth_request_thin_dto:
        return auth_request_thin_dto(self.auth_request_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.auth_request_uid, self.by_account_instance_uid, self.account_instance_uid, self.system_instance_uid, self.reset_guid, self.valid_till_date, self.lock_guid, self.lock_by, self.lock_date, self.is_checked, self.is_used, self.check_date, self.use_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class auth_role_read_dto(base_read_dto, auth_role_write_dto):
    ...
    def to_thin(self) -> auth_role_thin_dto:
        return auth_role_thin_dto(self.auth_role_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class auth_token_read_dto(base_read_dto, auth_token_write_dto):
    ...
    @classmethod
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0, base_dto.get_random_uid(), base_dto.get_random_uid(), datetime.datetime.now(), datetime.datetime.now(), 0, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, auth_token_uid: str , account_instance_uid: str , system_instance_uid: str , token_seq: int , token_hash: str , token_salt: str , valid_till_date: datetime.datetime  | None, last_use_date: datetime.datetime  | None, is_last: int ):
        return cls(0, auth_token_uid, account_instance_uid, system_instance_uid, token_seq, token_hash, token_salt, valid_till_date, last_use_date, is_last, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , auth_token_uid: str , account_instance_uid: str , system_instance_uid: str , token_seq: int , token_hash: str , token_salt: str , valid_till_date: datetime.datetime  | None, last_use_date: datetime.datetime  | None, is_last: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, auth_token_uid, account_instance_uid, system_instance_uid, token_seq, token_hash, token_salt, valid_till_date, last_use_date, is_last, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_token_write_dto):
        return cls(0, dto.auth_token_uid, dto.account_instance_uid, dto.system_instance_uid, dto.token_seq, dto.token_hash, dto.token_salt, dto.valid_till_date, dto.last_use_date, dto.is_last, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_token_read_dto(self.id, self.auth_token_uid, self.account_instance_uid, self.system_instance_uid, self.token_seq, self.token_hash, self.token_salt, self.valid_till_date, self.last_use_date, self.is_last, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["auth_token_uid"], d["account_instance_uid"], d["system_instance_uid"], d["token_seq"], d["token_hash"], d["token_salt"], d["valid_till_date"], d["last_use_date"], d["is_last"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> auth_token_thin_dto:
        return auth_token_thin_dto(self.auth_token_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.auth_token_uid, self.account_instance_uid, self.system_instance_uid, self.token_seq, self.token_hash, self.token_salt, self.valid_till_date, self.last_use_date, self.is_last, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class client_instance_read_dto(base_read_dto, client_instance_write_dto):
    ...
    def to_thin(self) -> client_instance_thin_dto:
        return client_instance_thin_dto(self.client_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class client_type_read_dto(base_read_dto, client_type_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , client_type_uid: str , system_version_uid: str , client_type_name: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def new_read_default(cls, client_type_uid: str , system_version_uid: str , client_type_name: str ):
        return cls(0, client_type_uid, system_version_uid, client_type_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , client_type_uid: str , system_version_uid: str , client_type_name: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, client_type_uid, system_version_uid, client_type_name, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: client_type_write_dto):
        return cls(0, dto.client_type_uid, dto.system_version_uid, dto.client_type_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return client_type_read_dto(self.id, self.client_type_uid, self.system_version_uid, self.client_type_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["client_type_uid"], d["system_version_uid"], d["client_type_name"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> client_type_thin_dto:
        return client_type_thin_dto(self.client_type_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.client_type_uid, self.system_version_uid, self.client_type_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class country_read_dto(base_read_dto, country_write_dto):
    ...
    def to_thin(self) -> country_thin_dto:
        return country_thin_dto(self.country_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class currency_read_dto(base_read_dto, currency_write_dto):
    ...
    def to_thin(self) -> currency_thin_dto:
        return currency_thin_dto(self.currency_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class entry_final_read_dto(base_read_dto, entry_final_write_dto):
    ...
    def to_thin(self) -> entry_final_thin_dto:
        return entry_final_thin_dto(self.entry_final_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class entry_save_read_dto(base_read_dto, entry_save_write_dto):
    ...
    def to_thin(self) -> entry_save_thin_dto:
        return entry_save_thin_dto(self.entry_save_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class event_channel_read_dto(base_read_dto, event_channel_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , event_channel_uid: str , system_version_uid: str , channel_type: str , channel_name: str , channel_definition: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def new_read_default(cls, event_channel_uid: str , system_version_uid: str , channel_type: str , channel_name: str , channel_definition: str ):
        return cls(0, event_channel_uid, system_version_uid, channel_type, channel_name, channel_definition, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , event_channel_uid: str , system_version_uid: str , channel_type: str , channel_name: str , channel_definition: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, event_channel_uid, system_version_uid, channel_type, channel_name, channel_definition, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: event_channel_write_dto):
        return cls(0, dto.event_channel_uid, dto.system_version_uid, dto.channel_type, dto.channel_name, dto.channel_definition, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return event_channel_read_dto(self.id, self.event_channel_uid, self.system_version_uid, self.channel_type, self.channel_name, self.channel_definition, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["event_channel_uid"], d["system_version_uid"], d["channel_type"], d["channel_name"], d["channel_definition"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> event_channel_thin_dto:
        return event_channel_thin_dto(self.event_channel_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.event_channel_uid, self.system_version_uid, self.channel_type, self.channel_name, self.channel_definition, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class event_instance_read_dto(base_read_dto, event_instance_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , event_instance_uid: str , system_instance_uid: str , event_type: str , event_object: str , event_method: str , event_parameters: str , event_signature: str , published_count: int , event_date: datetime.datetime , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0, datetime.datetime.now(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, event_instance_uid: str , system_instance_uid: str , event_type: str , event_object: str , event_method: str , event_parameters: str , event_signature: str , published_count: int , event_date: datetime.datetime ):
        return cls(0, event_instance_uid, system_instance_uid, event_type, event_object, event_method, event_parameters, event_signature, published_count, event_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , event_instance_uid: str , system_instance_uid: str , event_type: str , event_object: str , event_method: str , event_parameters: str , event_signature: str , published_count: int , event_date: datetime.datetime , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, event_instance_uid, system_instance_uid, event_type, event_object, event_method, event_parameters, event_signature, published_count, event_date, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: event_instance_write_dto):
        return cls(0, dto.event_instance_uid, dto.system_instance_uid, dto.event_type, dto.event_object, dto.event_method, dto.event_parameters, dto.event_signature, dto.published_count, dto.event_date, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return event_instance_read_dto(self.id, self.event_instance_uid, self.system_instance_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.published_count, self.event_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["event_instance_uid"], d["system_instance_uid"], d["event_type"], d["event_object"], d["event_method"], d["event_parameters"], d["event_signature"], d["published_count"], d["event_date"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> event_instance_thin_dto:
        return event_instance_thin_dto(self.event_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.event_instance_uid, self.system_instance_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.published_count, self.event_date, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class event_subscription_read_dto(base_read_dto, event_subscription_write_dto):
    ...
    def to_thin(self) -> event_subscription_thin_dto:
        return event_subscription_thin_dto(self.event_subscription_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class invoice_instance_read_dto(base_read_dto, invoice_instance_write_dto):
    ...
    def to_thin(self) -> invoice_instance_thin_dto:
        return invoice_instance_thin_dto(self.invoice_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class notification_instance_read_dto(base_read_dto, notification_instance_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , notification_instance_uid: str , client_instance_uid: str , account_instance_uid: str , notification_type: str , notification_topic: str , notification_format: str , notification_content: str , sending_status: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, notification_instance_uid: str , client_instance_uid: str , account_instance_uid: str , notification_type: str , notification_topic: str , notification_format: str , notification_content: str , sending_status: str ):
        return cls(0, notification_instance_uid, client_instance_uid, account_instance_uid, notification_type, notification_topic, notification_format, notification_content, sending_status, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , notification_instance_uid: str , client_instance_uid: str , account_instance_uid: str , notification_type: str , notification_topic: str , notification_format: str , notification_content: str , sending_status: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, notification_instance_uid, client_instance_uid, account_instance_uid, notification_type, notification_topic, notification_format, notification_content, sending_status, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: notification_instance_write_dto):
        return cls(0, dto.notification_instance_uid, dto.client_instance_uid, dto.account_instance_uid, dto.notification_type, dto.notification_topic, dto.notification_format, dto.notification_content, dto.sending_status, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return notification_instance_read_dto(self.id, self.notification_instance_uid, self.client_instance_uid, self.account_instance_uid, self.notification_type, self.notification_topic, self.notification_format, self.notification_content, self.sending_status, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["notification_instance_uid"], d["client_instance_uid"], d["account_instance_uid"], d["notification_type"], d["notification_topic"], d["notification_format"], d["notification_content"], d["sending_status"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> notification_instance_thin_dto:
        return notification_instance_thin_dto(self.notification_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.notification_instance_uid, self.client_instance_uid, self.account_instance_uid, self.notification_type, self.notification_topic, self.notification_format, self.notification_content, self.sending_status, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class project_budget_read_dto(base_read_dto, project_budget_write_dto):
    ...
    def to_thin(self) -> project_budget_thin_dto:
        return project_budget_thin_dto(self.project_budget_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class project_group_read_dto(base_read_dto, project_group_write_dto):
    ...
    def to_thin(self) -> project_group_thin_dto:
        return project_group_thin_dto(self.project_group_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class project_instance_read_dto(base_read_dto, project_instance_write_dto):
    ...
    def to_thin(self) -> project_instance_thin_dto:
        return project_instance_thin_dto(self.project_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class project_milestone_read_dto(base_read_dto, project_milestone_write_dto):
    ...
    def to_thin(self) -> project_milestone_thin_dto:
        return project_milestone_thin_dto(self.project_milestone_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class system_attribute_read_dto(base_read_dto, system_attribute_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_attribute_uid: str , system_object_uid: str , system_version_uid: str , column_name: str , attribute_name: str , attribute_type: str , attribute_label: str , attribute_description: str ):
        return cls(0, system_attribute_uid, system_object_uid, system_version_uid, column_name, attribute_name, attribute_type, attribute_label, attribute_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_attribute_uid: str , system_object_uid: str , system_version_uid: str , column_name: str , attribute_name: str , attribute_type: str , attribute_label: str , attribute_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_attribute_uid, system_object_uid, system_version_uid, column_name, attribute_name, attribute_type, attribute_label, attribute_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_attribute_write_dto):
        return cls(0, dto.system_attribute_uid, dto.system_object_uid, dto.system_version_uid, dto.column_name, dto.attribute_name, dto.attribute_type, dto.attribute_label, dto.attribute_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_attribute_read_dto(self.id, self.system_attribute_uid, self.system_object_uid, self.system_version_uid, self.column_name, self.attribute_name, self.attribute_type, self.attribute_label, self.attribute_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_attribute_uid"], d["system_object_uid"], d["system_version_uid"], d["column_name"], d["attribute_name"], d["attribute_type"], d["attribute_label"], d["attribute_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_attribute_thin_dto:
        return system_attribute_thin_dto(self.system_attribute_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_attribute_uid, self.system_object_uid, self.system_version_uid, self.column_name, self.attribute_name, self.attribute_type, self.attribute_label, self.attribute_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_change_read_dto(base_read_dto, system_change_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_change_uid: str , account_instance_uid: str , system_instance_uid: str , change_type: str , change_name: str , change_json: str ):
        return cls(0, system_change_uid, account_instance_uid, system_instance_uid, change_type, change_name, change_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_change_uid: str , account_instance_uid: str , system_instance_uid: str , change_type: str , change_name: str , change_json: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_change_uid, account_instance_uid, system_instance_uid, change_type, change_name, change_json, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_change_write_dto):
        return cls(0, dto.system_change_uid, dto.account_instance_uid, dto.system_instance_uid, dto.change_type, dto.change_name, dto.change_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_change_read_dto(self.id, self.system_change_uid, self.account_instance_uid, self.system_instance_uid, self.change_type, self.change_name, self.change_json, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_change_uid"], d["account_instance_uid"], d["system_instance_uid"], d["change_type"], d["change_name"], d["change_json"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_change_thin_dto:
        return system_change_thin_dto(self.system_change_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_change_uid, self.account_instance_uid, self.system_instance_uid, self.change_type, self.change_name, self.change_json, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_database_read_dto(base_read_dto, system_database_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_database_uid: str , db_url: str , db_host: str , db_name: str , db_user: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_database_uid: str , db_url: str , db_host: str , db_name: str , db_user: str ):
        return cls(0, system_database_uid, db_url, db_host, db_name, db_user, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_database_uid: str , db_url: str , db_host: str , db_name: str , db_user: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_database_uid, db_url, db_host, db_name, db_user, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_database_write_dto):
        return cls(0, dto.system_database_uid, dto.db_url, dto.db_host, dto.db_name, dto.db_user, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_database_read_dto(self.id, self.system_database_uid, self.db_url, self.db_host, self.db_name, self.db_user, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_database_uid"], d["db_url"], d["db_host"], d["db_name"], d["db_user"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_database_thin_dto:
        return system_database_thin_dto(self.system_database_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_database_uid, self.db_url, self.db_host, self.db_name, self.db_user, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_exception_read_dto(base_read_dto, system_exception_write_dto):
    ...
    def to_thin(self) -> system_exception_thin_dto:
        return system_exception_thin_dto(self.system_exception_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class system_instance_read_dto(base_read_dto, system_instance_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_instance_uid: str , system_version_uid: str , host_name: str , host_ip: str , local_path: str , mode_name: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
        self.system_instance_uid = system_instance_uid
        self.system_version_uid = system_version_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_instance_uid: str , system_version_uid: str , host_name: str , host_ip: str , local_path: str , mode_name: str ):
        return cls(0, system_instance_uid, system_version_uid, host_name, host_ip, local_path, mode_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_instance_uid: str , system_version_uid: str , host_name: str , host_ip: str , local_path: str , mode_name: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_instance_uid, system_version_uid, host_name, host_ip, local_path, mode_name, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_instance_write_dto):
        return cls(0, dto.system_instance_uid, dto.system_version_uid, dto.host_name, dto.host_ip, dto.local_path, dto.mode_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_instance_read_dto(self.id, self.system_instance_uid, self.system_version_uid, self.host_name, self.host_ip, self.local_path, self.mode_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_instance_uid"], d["system_version_uid"], d["host_name"], d["host_ip"], d["local_path"], d["mode_name"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_instance_thin_dto:
        return system_instance_thin_dto(self.system_instance_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_instance_uid, self.system_version_uid, self.host_name, self.host_ip, self.local_path, self.mode_name, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_object_read_dto(base_read_dto, system_object_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_object_uid: str , system_version_uid: str , object_name: str , object_type: str , table_name: str , key_name: str , parent_system_object_uid: str  | None, row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
        self.system_object_uid = system_object_uid
        self.system_version_uid = system_version_uid
    ...
    @classmethod
    def new_read_default(cls, system_object_uid: str , system_version_uid: str , object_name: str , object_type: str , table_name: str , key_name: str , parent_system_object_uid: str  | None):
        return cls(0, system_object_uid, system_version_uid, object_name, object_type, table_name, key_name, parent_system_object_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_object_uid: str , system_version_uid: str , object_name: str , object_type: str , table_name: str , key_name: str , parent_system_object_uid: str  | None, row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_object_uid, system_version_uid, object_name, object_type, table_name, key_name, parent_system_object_uid, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_object_write_dto):
        return cls(0, dto.system_object_uid, dto.system_version_uid, dto.object_name, dto.object_type, dto.table_name, dto.key_name, dto.parent_system_object_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_object_read_dto(self.id, self.system_object_uid, self.system_version_uid, self.object_name, self.object_type, self.table_name, self.key_name, self.parent_system_object_uid, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_object_uid"], d["system_version_uid"], d["object_name"], d["object_type"], d["table_name"], d["key_name"], d["parent_system_object_uid"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_object_thin_dto:
        return system_object_thin_dto(self.system_object_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_object_uid, self.system_version_uid, self.object_name, self.object_type, self.table_name, self.key_name, self.parent_system_object_uid, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_object_type_read_dto(base_read_dto, system_object_type_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_object_type_uid: str , system_version_uid: str , system_object_uid: str , object_type_name: str , object_type_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_object_type_uid: str , system_version_uid: str , system_object_uid: str , object_type_name: str , object_type_description: str ):
        return cls(0, system_object_type_uid, system_version_uid, system_object_uid, object_type_name, object_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_object_type_uid: str , system_version_uid: str , system_object_uid: str , object_type_name: str , object_type_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_object_type_uid, system_version_uid, system_object_uid, object_type_name, object_type_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_object_type_write_dto):
        return cls(0, dto.system_object_type_uid, dto.system_version_uid, dto.system_object_uid, dto.object_type_name, dto.object_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_object_type_read_dto(self.id, self.system_object_type_uid, self.system_version_uid, self.system_object_uid, self.object_type_name, self.object_type_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_object_type_uid"], d["system_version_uid"], d["system_object_uid"], d["object_type_name"], d["object_type_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    def to_write(self) -> system_object_type_write_dto:
    ...
    def to_thin(self) -> system_object_type_thin_dto:
        return system_object_type_thin_dto(self.system_object_type_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_object_type_uid, self.system_version_uid, self.system_object_uid, self.object_type_name, self.object_type_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_setting_read_dto(base_read_dto, system_setting_write_dto):
    ...
    def to_thin(self) -> system_setting_thin_dto:
        return system_setting_thin_dto(self.system_setting_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
...
class system_state_read_dto(base_read_dto, system_state_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_state_uid: str , system_instance_uid: str , mem_free: int , mem_max: int , objects_count: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
    ...
    @classmethod
    def new_read_default(cls, system_state_uid: str , system_instance_uid: str , mem_free: int , mem_max: int , objects_count: int ):
        return cls(0, system_state_uid, system_instance_uid, mem_free, mem_max, objects_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_state_uid: str , system_instance_uid: str , mem_free: int , mem_max: int , objects_count: int , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_state_uid, system_instance_uid, mem_free, mem_max, objects_count, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_state_write_dto):
        return cls(0, dto.system_state_uid, dto.system_instance_uid, dto.mem_free, dto.mem_max, dto.objects_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_state_read_dto(self.id, self.system_state_uid, self.system_instance_uid, self.mem_free, self.mem_max, self.objects_count, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_state_uid"], d["system_instance_uid"], d["mem_free"], d["mem_max"], d["objects_count"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_state_thin_dto:
        return system_state_thin_dto(self.system_state_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_state_uid, self.system_instance_uid, self.mem_free, self.mem_max, self.objects_count, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
...
class system_version_read_dto(base_read_dto, system_version_write_dto):
    ...
    removed_by: str  | None
    custom_attributes: str
    def __init__(self, id: int , system_version_uid: str , version_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        self.id = id
        self.system_version_uid = system_version_uid
    ...
    @classmethod
    def new_read_default(cls, system_version_uid: str , version_description: str ):
        return cls(0, system_version_uid, version_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, id: int , system_version_uid: str , version_description: str , row_guid: str , row_version: int , is_active: int , created_date: datetime.datetime , created_by: str , last_updated_date: datetime.datetime , last_updated_by: str , removed_date: datetime.datetime  | None, removed_by: str  | None, custom_attributes: str ):
        return cls(id, system_version_uid, version_description, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_version_write_dto):
        return cls(0, dto.system_version_uid, dto.version_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_version_read_dto(self.id, self.system_version_uid, self.version_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["id"], d["system_version_uid"], d["version_description"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
    ...
    def to_thin(self) -> system_version_thin_dto:
        return system_version_thin_dto(self.system_version_uid, self.created_date, self.is_active)
    def touch(self, updated_by: str = "system"):
        self.last_updated_date = datetime.datetime.now()
        self.last_updated_by = updated_by
        self.row_version = self.row_version+1
    def get_list_all_values(self) -> list[any]:
        return [self.id, self.system_version_uid, self.version_description, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes]
    def get_list_update_values(self, updated_by: str) -> list[any]:
