...
class account_read_dto(base_read_dto, account_write_dto):
    ...
    def __init__(self, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    @classmethod
    def new_read_default(cls, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int):
        return cls(0, account_uid, account_name, tenant_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, display_name, is_system, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, account_uid: str, account_name: str, tenant_uid: str, account_type_uid: str, account_title_uid: str, account_division_uid: str, account_group_uid: str, auth_identity_uid: str, account_email: str, display_name: str, is_system: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(account_uid, account_name, tenant_uid, account_type_uid, account_title_uid, account_division_uid, account_group_uid, auth_identity_uid, account_email, display_name, is_system, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_write_dto):
        return cls(0, dto.account_uid, dto.account_name, dto.tenant_uid, dto.account_type_uid, dto.account_title_uid, dto.account_division_uid, dto.account_group_uid, dto.auth_identity_uid, dto.account_email, dto.display_name, dto.is_system, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_read_dto(self.account_uid, self.account_name, self.tenant_uid, self.account_type_uid, self.account_title_uid, self.account_division_uid, self.account_group_uid, self.auth_identity_uid, self.account_email, self.display_name, self.is_system, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["account_uid"], d["account_name"], d["tenant_uid"], d["account_type_uid"], d["account_title_uid"], d["account_division_uid"], d["account_group_uid"], d["auth_identity_uid"], d["account_email"], d["display_name"], d["is_system"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
...
class account_title_responsibility_read_dto(base_read_dto, account_title_responsibility_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    @classmethod
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int):
        return cls(0, account_title_responsibility_uid, account_title_responsibility_name, tenant_uid, account_title_uid, responsibility_description, responsibility_priority, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, account_title_responsibility_uid: str, account_title_responsibility_name: str, tenant_uid: str, account_title_uid: str, responsibility_description: str, responsibility_priority: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(account_title_responsibility_uid, account_title_responsibility_name, tenant_uid, account_title_uid, responsibility_description, responsibility_priority, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_title_responsibility_write_dto):
        return cls(0, dto.account_title_responsibility_uid, dto.account_title_responsibility_name, dto.tenant_uid, dto.account_title_uid, dto.responsibility_description, dto.responsibility_priority, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
...
class account_type_read_dto(base_read_dto, account_type_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, account_type_uid: str, account_type_name: str, account_type_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.account_type_uid = account_type_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, account_type_uid: str, account_type_name: str, account_type_description: str):
        return cls(0, account_type_uid, account_type_name, account_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, account_type_uid: str, account_type_name: str, account_type_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(account_type_uid, account_type_name, account_type_description, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: account_type_write_dto):
        return cls(0, dto.account_type_uid, dto.account_type_name, dto.account_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return account_type_read_dto(self.account_type_uid, self.account_type_name, self.account_type_description, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["account_type_uid"], d["account_type_name"], d["account_type_description"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class audit_change_read_dto(base_read_dto, audit_change_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str):
        return cls(0, system_change_uid, system_change_name, account_uid, audit_type_uid, change_type, change_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_change_uid: str, system_change_name: str, account_uid: str, audit_type_uid: str, change_type: str, change_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_change_uid, system_change_name, account_uid, audit_type_uid, change_type, change_json, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: audit_change_write_dto):
        return cls(0, dto.system_change_uid, dto.system_change_name, dto.account_uid, dto.audit_type_uid, dto.change_type, dto.change_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return audit_change_read_dto(self.system_change_uid, self.system_change_name, self.account_uid, self.audit_type_uid, self.change_type, self.change_json, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_change_uid"], d["system_change_name"], d["account_uid"], d["audit_type_uid"], d["change_type"], d["change_json"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class auth_session_read_dto(base_read_dto, auth_session_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str):
        return cls(0, auth_session_uid, auth_session_name, tenant_uid, account_uid, session_token, browser_name, browser_, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, auth_session_uid: str, auth_session_name: str, tenant_uid: str | None, account_uid: str | None, session_token: str, browser_name: str, browser_: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(auth_session_uid, auth_session_name, tenant_uid, account_uid, session_token, browser_name, browser_, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: auth_session_write_dto):
        return cls(0, dto.auth_session_uid, dto.auth_session_name, dto.tenant_uid, dto.account_uid, dto.session_token, dto.browser_name, dto.browser_, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return auth_session_read_dto(self.auth_session_uid, self.auth_session_name, self.tenant_uid, self.account_uid, self.session_token, self.browser_name, self.browser_, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["auth_session_uid"], d["auth_session_name"], d["tenant_uid"], d["account_uid"], d["session_token"], d["browser_name"], d["browser_"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class client_account_read_dto(base_read_dto, client_account_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, client_account_uid: str, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str):
        return cls(0, client_account_uid, client_account_name, tenant_uid, client_uid, account_uid, client_role_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, client_account_uid: str, client_account_name: str, tenant_uid: str, client_uid: str, account_uid: str, client_role_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(client_account_uid, client_account_name, tenant_uid, client_uid, account_uid, client_role_uid, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: client_account_write_dto):
        return cls(0, dto.client_account_uid, dto.client_account_name, dto.tenant_uid, dto.client_uid, dto.account_uid, dto.client_role_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["client_account_uid"], d["client_account_name"], d["tenant_uid"], d["client_uid"], d["account_uid"], d["client_role_uid"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class client_country_read_dto(base_read_dto, client_country_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str):
        return cls(0, client_country_uid, client_country_name, tenant_uid, client_uid, country_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, client_country_uid: str, client_country_name: str, tenant_uid: str, client_uid: str, country_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(client_country_uid, client_country_name, tenant_uid, client_uid, country_uid, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: client_country_write_dto):
        return cls(0, dto.client_country_uid, dto.client_country_name, dto.tenant_uid, dto.client_uid, dto.country_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return client_country_read_dto(self.client_country_uid, self.client_country_name, self.tenant_uid, self.client_uid, self.country_uid, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["client_country_uid"], d["client_country_name"], d["tenant_uid"], d["client_uid"], d["country_uid"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class currency_read_dto(base_read_dto, currency_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, currency_uid: str, currency_name: str, is_focused: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.currency_uid = currency_uid
        self.currency_name = currency_name
        self.is_focused = is_focused
        self.row_instance = row_instance
    ...
    @classmethod
    def new_read_full(cls, currency_uid: str, currency_name: str, is_focused: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(currency_uid, currency_name, is_focused, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    ...
    def clone_read(self):
        return currency_read_dto(self.currency_uid, self.currency_name, self.is_focused, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["currency_uid"], d["currency_name"], d["is_focused"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class event_instance_read_dto(base_read_dto, event_instance_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    @classmethod
    def new_read_default(cls, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int):
        return cls(0, event_instance_uid, event_instance_name, client_uid, event_type, event_object, event_method, event_parameters, event_signature, event_date, published_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, event_instance_uid: str, event_instance_name: str, client_uid: str, event_type: str, event_object: str, event_method: str, event_parameters: str, event_signature: str, event_date: datetime.datetime, published_count: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(event_instance_uid, event_instance_name, client_uid, event_type, event_object, event_method, event_parameters, event_signature, event_date, published_count, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: event_instance_write_dto):
        return cls(0, dto.event_instance_uid, dto.event_instance_name, dto.client_uid, dto.event_type, dto.event_object, dto.event_method, dto.event_parameters, dto.event_signature, dto.event_date, dto.published_count, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return event_instance_read_dto(self.event_instance_uid, self.event_instance_name, self.client_uid, self.event_type, self.event_object, self.event_method, self.event_parameters, self.event_signature, self.event_date, self.published_count, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["event_instance_uid"], d["event_instance_name"], d["client_uid"], d["event_type"], d["event_object"], d["event_method"], d["event_parameters"], d["event_signature"], d["event_date"], d["published_count"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class event_observer_read_dto(base_read_dto, event_observer_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, event_observer_uid: str, event_observer_name: str, event_observer_definition: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, event_observer_uid: str, event_observer_name: str, event_observer_definition: str):
        return cls(0, event_observer_uid, event_observer_name, event_observer_definition, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, event_observer_uid: str, event_observer_name: str, event_observer_definition: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(event_observer_uid, event_observer_name, event_observer_definition, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: event_observer_write_dto):
        return cls(0, dto.event_observer_uid, dto.event_observer_name, dto.event_observer_definition, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["event_observer_uid"], d["event_observer_name"], d["event_observer_definition"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class invoice_flow_read_dto(base_read_dto, invoice_flow_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str):
        return cls(0, invoice_flow_uid, invoice_flow_name, flow_description, flow_definition_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, invoice_flow_uid: str, invoice_flow_name: str, flow_description: str, flow_definition_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(invoice_flow_uid, invoice_flow_name, flow_description, flow_definition_json, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: invoice_flow_write_dto):
        return cls(0, dto.invoice_flow_uid, dto.invoice_flow_name, dto.flow_description, dto.flow_definition_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return invoice_flow_read_dto(self.invoice_flow_uid, self.invoice_flow_name, self.flow_description, self.flow_definition_json, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["invoice_flow_uid"], d["invoice_flow_name"], d["flow_description"], d["flow_definition_json"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class invoice_flow_state_read_dto(base_read_dto, invoice_flow_state_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str):
        return cls(0, invoice_flow_state_uid, invoice_flow_state_name, invoice_flow_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, invoice_flow_state_uid: str, invoice_flow_state_name: str, invoice_flow_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(invoice_flow_state_uid, invoice_flow_state_name, invoice_flow_uid, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: invoice_flow_state_write_dto):
        return cls(0, dto.invoice_flow_state_uid, dto.invoice_flow_state_name, dto.invoice_flow_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["invoice_flow_state_uid"], d["invoice_flow_state_name"], d["invoice_flow_uid"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class process_read_dto(base_read_dto, process_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str):
        return cls(0, process_uid, process_name, tenant_uid, account_uid, process_type_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, process_uid: str, process_name: str, tenant_uid: str, account_uid: str, process_type_uid: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(process_uid, process_name, tenant_uid, account_uid, process_type_uid, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: process_write_dto):
        return cls(0, dto.process_uid, dto.process_name, dto.tenant_uid, dto.account_uid, dto.process_type_uid, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return process_read_dto(self.process_uid, self.process_name, self.tenant_uid, self.account_uid, self.process_type_uid, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["process_uid"], d["process_name"], d["tenant_uid"], d["account_uid"], d["process_type_uid"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class report_format_read_dto(base_read_dto, report_format_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, report_format_uid: str, report_format_name: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, report_format_uid: str, report_format_name: str):
        return cls(0, report_format_uid, report_format_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, report_format_uid: str, report_format_name: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(report_format_uid, report_format_name, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: report_format_write_dto):
        return cls(0, dto.report_format_uid, dto.report_format_name, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return report_format_read_dto(self.report_format_uid, self.report_format_name, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["report_format_uid"], d["report_format_name"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class storage_read_dto(base_read_dto, storage_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str):
        return cls(0, storage_uid, storage_name, storage_class, storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, storage_uid: str, storage_name: str, storage_class: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(storage_uid, storage_name, storage_class, storage_parameters_json, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: storage_write_dto):
        return cls(0, dto.storage_uid, dto.storage_name, dto.storage_class, dto.storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return storage_read_dto(self.storage_uid, self.storage_name, self.storage_class, self.storage_parameters_json, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_uid"], d["storage_name"], d["storage_class"], d["storage_parameters_json"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class storage_query_read_dto(base_read_dto, storage_query_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.storage_connection_uid = storage_connection_uid
        self.storage_connection_name = storage_connection_name
        self.storage_uid = storage_uid
        self.storage_parameters_json = storage_parameters_json
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str):
        return cls(0, storage_connection_uid, storage_connection_name, storage_uid, storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, storage_connection_uid: str, storage_connection_name: str, storage_uid: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(storage_connection_uid, storage_connection_name, storage_uid, storage_parameters_json, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: storage_query_write_dto):
        return cls(0, dto.storage_connection_uid, dto.storage_connection_name, dto.storage_uid, dto.storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return storage_query_read_dto(self.storage_connection_uid, self.storage_connection_name, self.storage_uid, self.storage_parameters_json, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_connection_uid"], d["storage_connection_name"], d["storage_uid"], d["storage_parameters_json"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class storage_type_read_dto(base_read_dto, storage_type_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str):
        return cls(0, storage_type_uid, storage_type_name, storage_class, storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, storage_type_uid: str, storage_type_name: str, storage_class: str, storage_parameters_json: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(storage_type_uid, storage_type_name, storage_class, storage_parameters_json, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: storage_type_write_dto):
        return cls(0, dto.storage_type_uid, dto.storage_type_name, dto.storage_class, dto.storage_parameters_json, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return storage_type_read_dto(self.storage_type_uid, self.storage_type_name, self.storage_class, self.storage_parameters_json, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["storage_type_uid"], d["storage_type_name"], d["storage_class"], d["storage_parameters_json"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class synchronization_type_read_dto(base_read_dto, synchronization_type_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.synchronization_type_uid = synchronization_type_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), "", "", "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str):
        return cls(0, synchronization_type_uid, synchronization_type_name, sync_type, sync_class_came, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, synchronization_type_uid: str, synchronization_type_name: str, sync_type: str, sync_class_came: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(synchronization_type_uid, synchronization_type_name, sync_type, sync_class_came, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: synchronization_type_write_dto):
        return cls(0, dto.synchronization_type_uid, dto.synchronization_type_name, dto.sync_type, dto.sync_class_came, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return synchronization_type_read_dto(self.synchronization_type_uid, self.synchronization_type_name, self.sync_type, self.sync_class_came, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["synchronization_type_uid"], d["synchronization_type_name"], d["sync_type"], d["sync_class_came"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_attribute_read_dto(base_read_dto, system_attribute_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str):
        return cls(0, system_attribute_uid, system_attribute_name, system_object_uid, column_name, attribute_type, attribute_label, attribute_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_attribute_uid: str, system_attribute_name: str, system_object_uid: str, column_name: str, attribute_type: str, attribute_label: str, attribute_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_attribute_uid, system_attribute_name, system_object_uid, column_name, attribute_type, attribute_label, attribute_description, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_attribute_write_dto):
        return cls(0, dto.system_attribute_uid, dto.system_attribute_name, dto.system_object_uid, dto.column_name, dto.attribute_type, dto.attribute_label, dto.attribute_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_attribute_uid"], d["system_attribute_name"], d["system_object_uid"], d["column_name"], d["attribute_type"], d["attribute_label"], d["attribute_description"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_database_read_dto(base_read_dto, system_database_write_dto):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_database_uid: str, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str):
        return cls(0, system_database_uid, system_database_name, db_url, db_host, db_name, db_user, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_database_uid: str, system_database_name: str, db_url: str, db_host: str, db_name: str, db_user: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_database_uid, system_database_name, db_url, db_host, db_name, db_user, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_database_write_dto):
        return cls(0, dto.system_database_uid, dto.system_database_name, dto.db_url, dto.db_host, dto.db_name, dto.db_user, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_database_uid"], d["system_database_name"], d["db_url"], d["db_host"], d["db_name"], d["db_user"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_license_read_dto(base_read_dto, system_license_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_license_uid: str, system_license_name: str, license_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_license_uid: str, system_license_name: str, license_description: str):
        return cls(0, system_license_uid, system_license_name, license_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_license_uid: str, system_license_name: str, license_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_license_uid, system_license_name, license_description, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_license_write_dto):
        return cls(0, dto.system_license_uid, dto.system_license_name, dto.license_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_license_read_dto(self.system_license_uid, self.system_license_name, self.license_description, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_license_uid"], d["system_license_name"], d["license_description"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_lock_read_dto(base_read_dto, system_lock_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str):
        return cls(0, system_lock_uid, system_lock_name, lock_account_uid, lock_comment, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_lock_uid: str, system_lock_name: str, lock_account_uid: str, lock_comment: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_lock_uid, system_lock_name, lock_account_uid, lock_comment, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_lock_write_dto):
        return cls(0, dto.system_lock_uid, dto.system_lock_name, dto.lock_account_uid, dto.lock_comment, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_lock_read_dto(self.system_lock_uid, self.system_lock_name, self.lock_account_uid, self.lock_comment, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_lock_uid"], d["system_lock_name"], d["lock_account_uid"], d["lock_comment"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_object_read_dto(base_read_dto, system_object_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.system_object_uid = system_object_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str):
        return cls(0, system_object_uid, system_object_name, system_version_uid, system_table_uid, system_object_type_uid, parent_system_object_uid, object_type, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_object_uid: str, system_object_name: str, system_version_uid: str, system_table_uid: str, system_object_type_uid: str, parent_system_object_uid: str | None, object_type: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_object_uid, system_object_name, system_version_uid, system_table_uid, system_object_type_uid, parent_system_object_uid, object_type, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_object_write_dto):
        return cls(0, dto.system_object_uid, dto.system_object_name, dto.system_version_uid, dto.system_table_uid, dto.system_object_type_uid, dto.parent_system_object_uid, dto.object_type, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_object_read_dto(self.system_object_uid, self.system_object_name, self.system_version_uid, self.system_table_uid, self.system_object_type_uid, self.parent_system_object_uid, self.object_type, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_object_uid"], d["system_object_name"], d["system_version_uid"], d["system_table_uid"], d["system_object_type_uid"], d["parent_system_object_uid"], d["object_type"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_object_type_read_dto(base_read_dto, system_object_type_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_object_type_uid: str, system_object_type_name: str, object_type_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.system_object_type_uid = system_object_type_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_object_type_uid: str, system_object_type_name: str, object_type_description: str):
        return cls(0, system_object_type_uid, system_object_type_name, object_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_object_type_uid: str, system_object_type_name: str, object_type_description: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_object_type_uid, system_object_type_name, object_type_description, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_object_type_write_dto):
        return cls(0, dto.system_object_type_uid, dto.system_object_type_name, dto.object_type_description, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_object_type_read_dto(self.system_object_type_uid, self.system_object_type_name, self.object_type_description, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_object_type_uid"], d["system_object_type_name"], d["object_type_description"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_setting_read_dto(base_read_dto, system_setting_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_setting_uid: str, system_setting_name: str, setting_value: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_setting_uid: str, system_setting_name: str, setting_value: str):
        return cls(0, system_setting_uid, system_setting_name, setting_value, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_setting_uid: str, system_setting_name: str, setting_value: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_setting_uid, system_setting_name, setting_value, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_setting_write_dto):
        return cls(0, dto.system_setting_uid, dto.system_setting_name, dto.setting_value, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_setting_uid"], d["system_setting_name"], d["setting_value"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_table_read_dto(base_read_dto, system_table_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        self.system_table_uid = system_table_uid
    ...
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str):
        return cls(0, system_table_uid, system_table_name, parent_system_table_uid, key_name, table_code, table_comment, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_table_uid: str, system_table_name: str, parent_system_table_uid: str | None, key_name: str, table_code: str, table_comment: str, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_table_uid, system_table_name, parent_system_table_uid, key_name, table_code, table_comment, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_table_write_dto):
        return cls(0, dto.system_table_uid, dto.system_table_name, dto.parent_system_table_uid, dto.key_name, dto.table_code, dto.table_comment, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_table_read_dto(self.system_table_uid, self.system_table_name, self.parent_system_table_uid, self.key_name, self.table_code, self.table_comment, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_table_uid"], d["system_table_name"], d["parent_system_table_uid"], d["key_name"], d["table_code"], d["table_comment"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class system_thread_read_dto(base_read_dto, system_thread_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    @classmethod
    def random_read(cls):
        return cls(0, base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), base_dto.get_random_uid(), 0, 0, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_default(cls, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int):
        return cls(0, system_thread_uid, system_thread_name, thread_name, parent_object, ticks_count, sleep_time, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, system_thread_uid: str, system_thread_name: str, thread_name: str, parent_object: str, ticks_count: int, sleep_time: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(system_thread_uid, system_thread_name, thread_name, parent_object, ticks_count, sleep_time, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: system_thread_write_dto):
        return cls(0, dto.system_thread_uid, dto.system_thread_name, dto.thread_name, dto.parent_object, dto.ticks_count, dto.sleep_time, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
        return system_thread_read_dto(self.system_thread_uid, self.system_thread_name, self.thread_name, self.parent_object, self.ticks_count, self.sleep_time, self.row_instance, self.row_lock, self.row_owner, self.row_seq, self.row_guid, self.row_version, self.is_active, self.created_date, self.created_by, self.last_updated_date, self.last_updated_by, self.removed_date, self.removed_by, self.custom_attributes)
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["system_thread_uid"], d["system_thread_name"], d["thread_name"], d["parent_object"], d["ticks_count"], d["sleep_time"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
...
class tenant_license_read_dto(base_read_dto, tenant_license_write_dto):
    ...
    removed_by: str | None
    custom_attributes: str
    def __init__(self, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
    ...
    @classmethod
    def new_read_default(cls, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int):
        return cls(0, tenant_license_uid, tenant_license_name, tenant_uid, system_license_uid, start_date, end_date, is_approved, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, "{}")
    @classmethod
    def new_read_full(cls, tenant_license_uid: str, tenant_license_name: str, tenant_uid: str, system_license_uid: str, start_date: datetime.datetime, end_date: datetime.datetime, is_approved: int, row_instance: str, row_lock: str | None, row_owner: str, row_seq: int, row_guid: str, row_version: int, is_active: int, created_date: datetime.datetime, created_by: str, last_updated_date: datetime.datetime, last_updated_by: str, removed_date: datetime.datetime | None, removed_by: str | None, custom_attributes: str):
        return cls(tenant_license_uid, tenant_license_name, tenant_uid, system_license_uid, start_date, end_date, is_approved, row_instance, row_lock, row_owner, row_seq, row_guid, row_version, is_active, created_date, created_by, last_updated_date, last_updated_by, removed_date, removed_by, custom_attributes)
    @classmethod
    def from_write(cls, dto: tenant_license_write_dto):
        return cls(0, dto.tenant_license_uid, dto.tenant_license_name, dto.tenant_uid, dto.system_license_uid, dto.start_date, dto.end_date, dto.is_approved, "", 0, 1, datetime.datetime.now(), "system", datetime.datetime.now(), "system", None, None, dto.custom_attributes)
    def clone_read(self):
    ...
    @classmethod
    def from_dictionary(cls, d: dict[str, any]):
        return cls(d["tenant_license_uid"], d["tenant_license_name"], d["tenant_uid"], d["system_license_uid"], d["start_date"], d["end_date"], d["is_approved"], d["row_instance"], d["row_lock"], d["row_owner"], d["row_seq"], d["row_guid"], d["row_version"], d["is_active"], d["created_date"], d["created_by"], d["last_updated_date"], d["last_updated_by"], d["removed_date"], d["removed_by"], d["custom_attributes"])
    def to_read_dict(self) -> dict:
        return asdict(self)
